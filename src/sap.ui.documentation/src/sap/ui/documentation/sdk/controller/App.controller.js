        ...
        return BaseController.extend(
            "sap.ui.documentation.sdk.controller.App",
            {
                ...
                onInit: function () {
                    ...
                    this.getOwnerComponent()
                        ...
                        .then(
                            function () {
                                if (
                                    this.getModel("versionData").getProperty(
                                        "/isOpenUI5",
                                    )
                                ) {
                                    this.MENU_LINKS_MAP["Terms of Use"] =
                                        "TermsOfUse.txt";
                                }
                            }.bind(this),
                        );
                    ...
                    this._oConfigUtil =
                        this.getOwnerComponent().getConfigUtil();
                    ...
                    if (
                        this._oConfigUtil.getCookieValue(
                ...
                onRouteChange: function (oEvent) {
                    if (
                        !this.oRouter.getRoute(oEvent.getParameter("name"))
                            ._oConfig.target
                    ) {
                        return;
                    }
                    ...
                    var sRouteName = oEvent.getParameter("name"),
                        sTabId =
                            this.oRouter.getRoute(sRouteName)._oConfig
                                .target[0] + "Tab",
                        ...
                        bHasMaster = this.getOwnerComponent()
                            .getConfigUtil()
                            .hasMasterView(sRouteName),
                        oMasterView,
                        sMasterViewId;
                    ...
                    if (bPhone && bHasMaster) {
                        ...
                        // view (for navigation)
                        oMasterView = this.getOwnerComponent()
                            .getConfigUtil()
                            .getMasterView(sRouteName);
                ...
                toggleMaster: function (oEvent) {
                    var bPressed = oEvent.getParameter("pressed"),
                        ...
                        isHideMode =
                            oSplitApp.getMode() === SplitAppMode.HideMode,
                        sMasterViewId =
                            this.getModel("appView").getProperty(
                                "/sMasterViewId",
                            ),
                        fnToggle;
                ...
                _createConfigurationBasedOnURIInput: function () {
                    ...
                    if (
                        !(
                            oUriParams.has("sap-ui-language") ||
                ...
                _prepareSupportedLangModelData: function () {
                    return Core.getConfiguration()
                        ...
                        .reduce(function (result, sLangAbbreviation) {
                            var langName;
                            if (
                                typeof sLangAbbreviation === "string" &&
                ...
                cookieSettingsDialogOpen: function () {
                    ...
                    Controller.create({
                        name: "sap.ui.documentation.sdk.controller.CookieSettingsDialog",
                    }).then(
                ...
                handleSaveAppSettings: function () {
                    var sLanguage =
                        Core.byId("LanguageSelect").getSelectedKey();
                ...
                onReleaseDialogOpen: function (oEvent) {
                    ...
                    if (!this._oNotesView) {
                        this._oNotesView = sap.ui.view({
                            id: "notesView",
                            viewName:
                                "sap.ui.documentation.sdk.view.ReleaseNotesView",
                            type: "Template",
                        });
                ...
                versionSwitchCustomComparator: function (
                    ...
                    return Version(sGroupTitleA).compareTo(
                        ...
                        this._oFeedbackDialog.updateContextData = function () {
                            ...
                            if (this.contextCheckBox.getSelected()) {
                                this.contextData.setValue(
                                    "Location: " +
                                        that._getCurrentPageRelativeURL() +
                                        "\n" +
                                        sUI5Distribution +
                                        " Version: " +
                                        sVersion,
                ...
                onFeedbackDialogSend: function () {
                    ...
                    if (this._oFeedbackDialog.contextCheckBox.getSelected()) {
                        data = {
                            ...
                            ratings: {
                                r1: {
                                    value: this._oFeedbackDialog.ratingStatus
                                        .value,
                                },
                            },
                            context: {
                        ...
                        bPhoneSize =
                            ...
                            iWidth <
                                Device.media._predefinedRangeSets[
                                    Device.media.RANGESETS.SAP_STANDARD_EXTENDED
                                ].points[0],
                        oViewModel = this.getModel("appView"),
                        bSearchMode = oViewModel.getProperty("/bSearchMode");
                ...
                _processVersionOverview: function (oVersionOverviewJson) {
                    ...
                    aVersions = aVersions
                        .filter(function (oVersion) {
                            return !!oVersion.hidden;
                        })
                        .forEach(function (oVersion) {
                            var aHiddenVersions = oVersion.hidden
                                .split(",")
                                .map(function (sVersion) {
                ...
                _processNeoAppJSON: function (oNeoAppJson) {
                    ...
                    if (!bIsInternal && !bIsSnapshotVersion) {
                        aRoutes = aRoutes.filter(function (oRoute) {
                            return (
                                oRoute.target.version.indexOf("-beta") === -1
                            );
                        });
                    }
                    ...
                    aRoutes = aRoutes.map(function (oRoute) {
                        ...
                        oVersionSummary.groupTitle =
                            oVersion.getMajor() + "." + oVersion.getMinor(); // E.g: Extract "1.52" from "1.52.5"
                ...
                _getUI5VersionGav: function () {
                    return this.getModel("versionData").getProperty(
                        "/versionGav",
                    );
                },

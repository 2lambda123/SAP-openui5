...
sap.ui.define(
    ...
    function(
      ...
      return BaseController.extend(
          "sap.ui.documentation.sdk.controller.App",
          {
            ...
            onInit : function() {
              ...
              var oViewModel = new JSONModel({
                ...
                bHideApiSection :
                    !!window["sap-ui-documentation-hideApiSection"],
                sAboutInfoSAPUI5 :
              ...
              this.getOwnerComponent().loadVersionInfo().then(
                  function() {
                    if (this.getModel("versionData")
                            .getProperty(
                                "/isOpenUI5",
                                )) {
              ...
              ResizeHandler.register(
                  this.oHeader,
                  this.onHeaderResize.bind(this),
              );
              this.oRouter.attachRouteMatched(
                  this.onRouteChange.bind(this),
              );
              this.oRouter.attachBypassed(
                  this.onRouteNotFound.bind(this),
              );
              ...
              if (this._oConfigUtil.getCookieValue(
                      this._oCookieNames.ALLOW_REQUIRED_COOKIES,
                      ) === "1" &&
            ...
            onAfterRendering : function() {
              ...
              if (this._oConfigUtil.getCookieValue(
                      this._oCookieNames.APPROVAL_REQUESTED,
                      ) !== "1") {
            ...
            onRouteChange : function(oEvent) {
              ...
              var sRouteName = oEvent.getParameter("name"),
                  sTabId =
                      this.oRouter.getRoute(sRouteName)._oConfig.target[0] +
                      "Tab",
              ...
              if (bPhone && bHasMaster) {
                // on phone we need the id of the master
                // view (for navigation)
                oMasterView =
            ...
            onRouteNotFound : function() {
              this.getRouter().myNavToWithoutHash(
                  "sap.ui.documentation.sdk.view.NotFound",
                  "XML",
                  false,
              );
              return;
            ...
            toggleMaster : function(oEvent) {
              var bPressed = oEvent.getParameter("pressed"),
                  ...
                  sMasterViewId = this.getModel("appView").getProperty(
                      "/sMasterViewId",
                      ),
                  fnToggle;
              ...
              if (!bPhone && (isShowHideMode || isHideMode)) {
                fnToggle =
                    bPressed ? oSplitApp.showMaster : oSplitApp.hideMaster;
            ...
            _createConfigurationBasedOnURIInput : function() {
              var oUriParams = UriParameters.fromQuery(
              ...
              if (!(oUriParams.has("sap-ui-language") ||
                ...
                this._aConfiguration.push(
                    DEMOKIT_CONFIGURATION_LANGUAGE,
                );
              }
            },
            ...
            _prepareSupportedLangModelData : function() {
              return Core.getConfiguration()
                  ...
                  .reduce(function(result, sLangAbbreviation) {
                    var langName;
            ...
            _getSelectedLanguage : function() {
              return this._oSupportedLangModel.getProperty(
                  "/selectedLang",
              );
            },
            ...
            settingsDialogOpen : function() {
              if (!this._oSettingsDialog) {
                Fragment
                    .load({
                      name :
                          "sap.ui.documentation.sdk.view.globalSettingsDialog",
                      controller : this,
                    })
                    .then(
                        function(oDialog) {
              ...
              Controller
                  ...
                  .then(
                      function(oController) {
                        ...
                        oController.openCookieSettingsDialog(
                            this._oConfigUtil,
                            this.getView(),
                        );
                      }.bind(this),
            ...
            handleCloseAppSettings :
                function() { this._oSettingsDialog.close(); },
            ...
            aboutDialogOpen : function() {
              if (!this._oAboutDialog) {
                this._oAboutDialog = new sap.ui.xmlfragment(
                    "aboutDialogFragment",
                    "sap.ui.documentation.sdk.view.AboutDialog",
                    this,
                );
            ...
            onAboutVersionDetails : function(oEvent) {
              ...
              var oNavCon = Fragment.byId(
                      "aboutDialogFragment",
                      "aboutNavCon",
                      ),
                  oDetailPage = Fragment.byId(
                      "aboutDialogFragment",
                      "aboutDetail",
                  );
            ...
            onReleaseDialogOpen : function(oEvent) {
              ...
              if (!this._oReleaseDialog) {
                this._oReleaseDialog = new sap.ui.xmlfragment(
                    ...
                    "sap.ui.documentation.sdk.view.ReleaseDialog",
                    this,
                );
             ...
             * @returns {number}
             */
            versionSwitchCustomComparator : function(
                sGroupTitleA,
                sGroupTitleB,
            ) {
              return Version(sGroupTitleA)
                  .compareTo(
                      Version(sGroupTitleB),
                  );
            },
            ...
            _createVersionDialog : function() {
              ...
              this._oChangeVersionDialog.setModel(
                  this._buildVersionDialogModel(),
              );
            ...
            feedbackDialogOpen : function() {
              ...
              if (!this._oFeedbackDialog) {
                ...
                this._oFeedbackDialog.textInput = Fragment.byId(
                    "feedbackDialogFragment",
                    "feedbackInput",
                );
                this._oFeedbackDialog.contextCheckBox = Fragment.byId(
                    "feedbackDialogFragment",
                    "pageContext",
                );
                this._oFeedbackDialog.contextData = Fragment.byId(
                    "feedbackDialogFragment",
                    "contextData",
                );
                this._oFeedbackDialog.ratingStatus = Fragment.byId(
                    "feedbackDialogFragment",
                    "ratingStatus",
                );
                this._oFeedbackDialog.ratingStatus.value = 0;
                this._oFeedbackDialog.sendButton = Fragment.byId(
                    "feedbackDialogFragment",
                    "sendButton",
                );
                this._oFeedbackDialog.ratingBar = [
                  {
                    button : Fragment.byId(
                        "feedbackDialogFragment",
                        "excellent",
                        ),
                    status : "Excellent",
                    displayStatus : oResourceBundle.getText(
                        "FEEDBACK_DIALOG_STATUS_EXCELLENT",
                        ),
                  },
                  {
                    button : Fragment.byId(
                  ...
                  },
                  {
                    ...
                    status : "Average",
                    displayStatus : oResourceBundle.getText(
                        "FEEDBACK_DIALOG_STATUS_AVERAGE",
                        ),
                  },
                  {
                    button : Fragment.byId(
                  ...
                  },
                  {
                    ...
                    status : "Very Poor",
                    displayStatus : oResourceBundle.getText(
                        "FEEDBACK_DIALOG_STATUS_VERY_POOR",
                        ),
                  },
                ];
                this._oFeedbackDialog.reset = function() {
                  ...
                  this.ratingBar.forEach(
                      function(oRatingBarElement) {
                        if (oRatingBarElement.button.getPressed()) {
                          oRatingBarElement.button.setPressed(
                              false,
                          );
                        }
                      },
            ...
            onFeedbackDialogSend : function() {
              ...
              if (this._oFeedbackDialog.contextCheckBox.getSelected()) {
                data = {
                  ...
                  ratings : {
                    r1 : {
                      value : this._oFeedbackDialog.ratingStatus.value,
                    },
                  },
                  context : {
            ...
            onPressRatingButton : function(oEvent) {
              ...
              that._oFeedbackDialog.ratingBar.forEach(
                  function(oRatingBarElement) {
                    if (oPressedButton !== oRatingBarElement.button) {
                      ...
                      if (!oRatingBarElement.button.getPressed()) {
                        ...
                        case "Excellent":
                          setRatingStatus(
                              "Success",
                              oRatingBarElement.displayStatus,
                              5,
                          );
                          break;
                        case "Good":
            ...
            _processVersionOverview : function(oVersionOverviewJson) {
              ...
              aVersions =
                  aVersions
                      .filter(function(oVersion) { return !!oVersion.hidden; })
            ...
            _requestVersionInfo : function() {
              Promise
                  ...
                  .then(
                      // Success
                      function(oValues) {
                        var aNeoAppVersions = this._processNeoAppJSON(
                                oValues[0],
                                ),
                            aHiddenValues = this._processVersionOverview(
                                oValues[1],
                            );

                        aNeoAppVersions = aNeoAppVersions.filter(
                            function(oVersion) {
                              return (aHiddenValues.indexOf(
                                          oVersion.version,
                                          ) === -1);
                            },
                        );
            ...
            _getUI5VersionGav : function() {
              return this.getModel("versionData")
                  .getProperty(
                      "/versionGav",
                  );
            },

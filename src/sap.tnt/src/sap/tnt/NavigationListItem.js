...
sap.ui.define(
    ...
    function(
      ...
      NavigationListItem.prototype.renderGroupItem = function(rm, control) {
        ...
        if (control.getExpanded()) {
          ...
          expandIconControl.setVisible(
              this.getItems().length > 0 && this.getHasExpander(),
          );
          expandIconControl.setSrc(
              this.getExpanded() ? NavigationListItem.collapseIcon
                                 : NavigationListItem.expandIcon,
          );
       ...
       * @private
       */
      NavigationListItem.prototype.renderFirstLevelNavItem = function(
          rm,
          control,
      ) {
       ...
       * @private
       */
      NavigationListItem.prototype._hasSelectedChild = function(
          selectedItem,
      ) {

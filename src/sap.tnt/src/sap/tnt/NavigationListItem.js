...
sap.ui.define(
    ...
    function (
        ...
        var NavigationListItem = Item.extend(
            ...
            /** @lends sap.tnt.NavigationListItem.prototype */ {
                metadata: {
                    ...
                    designtime:
                        "sap/tnt/designtime/NavigationListItem.designtime",
                },
            },
        );
        ...
        NavigationListItem.prototype.init = function () {
            ...
            this._resourceBundleTNTLib =
                Core.getLibraryResourceBundle("sap.tnt");
        };
        ...
        NavigationListItem.prototype.getLevel = function () {
            ...
            if (
                parent.getMetadata().getName() == "sap.tnt.NavigationListItem"
            ) {
        ...
        NavigationListItem.prototype.onkeydown = function (event) {
            ...
            if (
                (event.shiftKey && event.which == 189) ||
                ...
                event.which == KeyCodes.NUMPAD_PLUS ||
        ...
        NavigationListItem.prototype.expand = function (duration) {
            ...
            $container
                .stop(true, true)
                .slideDown(duration || "fast", function () {
        ...
        NavigationListItem.prototype.collapse = function (duration) {
            ...
            $container
                .stop(true, true)
                .slideUp(duration || "fast", function () {
                    $container.toggleClass("sapTntNavLIHiddenGroupItems");
                });
        ...
        NavigationListItem.prototype.renderGroupItem = function (rm, control) {
            ...
            if (
                !isListExpanded &&
                this._hasSelectedChild(control._selectedItem)
            ) {
                rm.class("sapTntNavLIItemSelected");
            }

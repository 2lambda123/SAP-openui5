    ...
    return new Designtime({
      "form" : {
        "items" : {
          ...
          "dependentfield1" : {
            "manifestpath" :
                "/sap.card/configuration/parameters/dependent1/value",
          ...
          "dependentfield2" : {
            "manifestpath" :
                "/sap.card/configuration/parameters/dependent2/value",
          ...
          "dependentfield3" : {
            "manifestpath" :
                "/sap.card/configuration/parameters/dependent3/value",
            "label" :
                "{= ${items>booleanVisualization/value}? 'dependentfield3 True' : 'dependentfield3 False' }",
            "type" : "string"
          }
        }
      }

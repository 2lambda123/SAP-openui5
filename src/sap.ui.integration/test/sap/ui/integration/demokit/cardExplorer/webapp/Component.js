sap.ui.define(
    [ "sap/ui/core/UIComponent", "sap/ui/core/IconPool", "sap/ui/Device" ],
    function(UIComponent, IconPool, Device) {
      "use strict";

      // add a window global variable for the internal flag to hide certain
      // sections
      window._isinternal = sap.ui.version.includes("SNAPSHOT") &&
                           !window.location.host.includes("openui5nightly");

      return UIComponent.extend("sap.ui.demo.cardExplorer.Component", {
        metadata : {manifest : "json", includes : [ "css/style.css" ]},

        /**
         * The component is initialized by UI5 automatically during the startup
         * of the app and calls the init method once. In this function, the
         * device models are set and the router is initialized.
         * @public
         * @override
         */
        init : function() {
         ...
         *     'sapUiSizeCozy' - or an empty string if no css class should be
         *     set
         */

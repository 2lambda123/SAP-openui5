    ...
    function (
        ...
        FileEditor.prototype._getEditor = function () {
            ...
            if (!oEditor) {
                ...
                oEditor._oEditor.completers = []; // This will prevent all auto complete and suggestions of the
                // editor
        ...
        FileEditor.prototype._onFileEdit = function (oEvent) {
            ...
            if (
                this._getHeader().getSelectedKey() ===
                this.getManifestFile().key
            ) {
        ...
        FileEditor.prototype._onSyntaxError = function () {
            var aErrorAnnotations =
                    this._getEditor()._oEditor.session.$annotations,
                sMessage = "";

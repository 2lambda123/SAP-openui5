...
sap.ui.define(
    ...
    function(
      ...
      "use strict";
      var FileEditor = Control.extend(
          "sap.ui.demo.cardExplorer.controls.FileEditor",
          {
            metadata : {
              properties : {
                /**
              ...
              events : {
                ...
                fileSwitch : {
                  parameters : {editable : {type : "boolean"}},
                },
              },
            },
            renderer : {
              ...
              render : function(oRm, oFileEditor) {
                ...
                oRm.renderControl(
                    oFileEditor._getReadOnlyWarningStrip(),
                );
        ...
        var aFetchPromises = this._aFiles.map(function(oFile) {
          ...
          oFile.promise = FileUtils.fetch(
              sap.ui.require.toUrl(
                  "sap/ui/demo/cardExplorer" + oFile.url,
                  ),
          );
      ...
      FileEditor.prototype.getManifestFile = function() {
        return this._aFiles.find(
            function(oFile) {
              if (oFile.key !== "designtime.js" &&
                  this._isFileEditable(oFile)) {
                return oFile;
              }
            }.bind(this),
        );
      ...
      FileEditor.prototype.getFilesWithContent = function() {
        ...
        return Promise.all(aFetchPromises)
            .then(
                function() { return this._aFiles; }.bind(this),
            );
      };

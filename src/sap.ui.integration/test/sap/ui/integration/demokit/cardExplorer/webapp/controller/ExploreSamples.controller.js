        ...
        return BaseController.extend(
            "sap.ui.demo.cardExplorer.controller.ExploreSamples",
            {
                ...
                onRunPressed: function (oEvent) {
                    this._fileEditor
                        .getManifestContent()
                        .then(this._updateSample.bind(this));
                },

                onChangeEditorClick: function () {
                    var sEditorType =
                        exploreSettingsModel.getProperty("/editorType");
                    if (sEditorType === "text") {
                ...
                _initCardEditor: function () {
                    ...
                    this._pLoadCardEditor =
                        this._pLoadCardEditor || loadCardEditor(); // only trigger request once
                    this._pLoadCardEditor
                        .then(
                            function (CardEditor) {
                ...
                _onResize: function () {
                    var isOrientationVertical =
                        ...
                        sRangeName =
                            Device.media.getCurrentRange("StdExt").name;
                ...
                _onCardAction: function (oEvent) {
                    var sType = oEvent.getParameter("type"),
                        ...
                        sKey =
                            exploreNavigationModel.getProperty("/selectedKey"),
                        sMessage;
                ...
                _showSample: function (oSample, oSubSample) {
                    ...
                    Promise.all([
                        ...
                        function () {
                            ...
                            if (bUseIFrame) {
                                oFrameWrapperEl._sSample = oSubSample
                                    ? oSample.key + "/" + oSubSample.key
                                    : oSample.key;
                ...
                _initCardSample: function () {
                    if (!this._pInitCardSample) {
                        this._pInitCardSample = Core.loadLibrary(
                            "sap.ui.integration",
                            { async: true },
                        )
                            .then(
                    ...
                    var oFrameWrapperEl = this.byId("iframeWrapper"),
                        oDelegate = {
                            onAfterRendering: function () {
                                var oFrameWrapperElDomRef =
                                        oFrameWrapperEl.getDomRef(),
                                    oFrame;
                ...
                createFrame: function (sSample) {
                    ...
                    oFrameEl.src = sap.ui.require.toUrl(
                        "sap/ui/demo/cardExplorer/samples/" +
                            sSample +
                            "/index.html",
                    );
                    oFrameEl.width = "100%";
                ...
                _updateSample: function (sValue) {
                    ...
                    if (exploreSettingsModel.getProperty("/useIFrame")) {
                        ...
                        try {
                            var sManifestFileName = this._sSampleManifestUrl
                                    .split("/")
                                    .pop(),

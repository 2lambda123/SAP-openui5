sap.ui.define([ "sap/ui/integration/Host" ], function(Host) {
  ...
  oHost.getDestinations = function() {
    return new Promise(function(resolve) {
      setTimeout(function() {
        resolve([
          {"name" : "Products"}, {"name" : "Orders"}, {"name" : "Portal"},
          {"name" : "Northwind"}, {"name" : "local"}
        ]);
      }, 1000);
    });
  };
    ...
    var context = {
      "sap.workzone" : {
        ...
        currentUser : {
          ...
          email : {
            label : "Email address of current Work Zone user",
            type : "string",
        ...
        currentCompany : {
          ...
          webHost : {
            ...
            description : "The host name of your Work Zone system.",

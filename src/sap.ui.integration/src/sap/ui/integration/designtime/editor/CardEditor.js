...
*/
              ...
              if (oControl.isReady()) {
                ...
                if (aItems) {
                  ...
                  for (var i = 0; i < aItems.length; i++) {
                    ...
                    if (oItem._cols === 1) {
                      oRm.addClass(
                          "sapUiIntegrationCardEditorItemCol" + ++iCol,
                      );
                    } else {
                      iCol = 0;
                    }
                    ...
                    if (oItem.isA("sap.m.Title")) {
                      ...
                      if (oLabel) {
                        ...
                        oRm.openStart("div");
                        oRm.addClass(
                            "sapUiIntegrationCardEditorItemLabel",
                        );
                        if (oDependent &&
                            oControl.getMode() !== "translation") {
       ...
       */
      CardEditor.prototype.setCard = function(
          vCardIdOrSettings,
      ...
      CardEditor.prototype._initCard = function(vCardIdOrSettings) {
        if (typeof vCardIdOrSettings === "string") {
          try {
            ...
            if (!instance) {
              // not a card instance, but a string
        ...
        if (typeof vCardIdOrSettings === "object") {
          ...
          this._oEditorCard._prepareToApplyManifestSettings = function() {
            Card.prototype._prepareToApplyManifestSettings.apply(
                this,
                arguments,
            );
            ...
            that._beforeManifestModel = new JSONModel(
                _beforeCurrentLayer,
            );
            ...
            that._originalManifestModel = new JSONModel(
                that._getOriginalManifestJson(),
            );
            that._initInternal();
            ...
            that.setModel(
                that._oEditorCard.getModel("i18n"),
                "i18n",
            );
            // add a context model
      ...
      CardEditor.prototype._initInternal = function() {
        ...
        var sDesigntime = this._oEditorCard.getManifestEntry(
                "/sap.card/designtime",
                ),
            oConfiguration = this._manifestModel.getProperty(
                "/sap.card/configuration",
                ),
        ...
        if (oDesigntimeConfig) {
          if (typeof oDesigntimeConfig === "function") {
            oPromise = new Promise(
                function(resolve, reject) {
                  ...
                  this._applyDesigntimeDefaults(
                      oDesigntimeInstance.getSettings(),
                  );
          ...
          oPromise = this._oEditorCard.loadDesigntime().then(
              function(oDesigntime) {
                this._applyDesigntimeDefaults(
                    oDesigntime.getSettings(),
                );
                return oDesigntime;
          ...
          oPromise = Promise.resolve(
              this._createParameterDesigntime(oConfiguration),
          );
        }
        oPromise.then(
            function(oDesigntime) {
              ...
              this._settingsModel = new JSONModel(
                  this._oDesigntimeInstance.getSettings(),
              );
              ...
              this._requireFields().then(
                  function() { this._startEditor(); }.bind(this),
              );
            }.bind(this),
        );
      };
      ...
      CardEditor.prototype._createContextModel = function() {
        ...
        var oContextDataPromise = new Promise(function(resolve, reject) {
          if (oHost && oHost.getContext) {
            ...
            setTimeout(function() {
              ...
              Log.error(
                  "Card Editor context could not be determined with " +
                      CONTEXT_TIMEOUT + ".",
              );
              bResolved = true;
              resolve({});
            ...
            oHost.getContext().then(function(oContextData) {
              if (bResolved) {
                Log.error(
                    "Card Editor context returned after more than " +
        ...
        oContextModel.getProperty = function(sPath, oContext) {
          ...
          if (sAbsolutePath.endsWith("/value")) {
            ...
            return JSONModel.prototype.getProperty.apply(
                this,
                arguments,
            );
          }
      ...
      CardEditor.prototype._createLabel = function(oConfig) {
        ...
        if (oConfig.description) {
          ...
          oIcon.addStyleClass(
              "sapUiIntegrationCardEditorDescriptionIcon",
          );
      ...
      CardEditor.prototype._updateProviderCard = function(aDependentFields) {
        if (this._ready) {
          ...
          this._oProviderCard.setManifestChanges([
      ...
      CardEditor.prototype._createField = function(oConfig) {
        ...
        var oBinding = this._settingsModel.bindProperty(
            oConfig._settingspath + "/value",
        );
       ...
       */
      CardEditor.prototype._addValueListModel = function(
          oConfig,
          oField,
          bIgnore,
      ) {
        ...
        if (oConfig.values && oConfig.values.data && this._oProviderCard &&
          ...
          this._settingsModel.setProperty(
              oConfig._settingspath + "/_loading",
              true,
          );
          oPromise
              .then(
      ...
      CardEditor.prototype._addItem = function(oConfig) {
        ...
        oConfig._beforeValue = this._beforeManifestModel.getProperty(
            oConfig.manifestpath,
        );
      ...
      CardEditor.prototype._getCurrentLanguageSpecificText = function(sKey) {
        ...
        if (typeof vI18n === "string") {
          ...
          if (sLanguage.indexOf("_") > -1) {
            aFallbacks.push(
                sLanguage.substring(0, sLanguage.indexOf("_")),
            );
          }
      ...
      CardEditor.prototype._startEditor = function() {
            ...
            if (oItem) {
              ...
              if (oItem.type === "string") {
                ...
                if (sPlaceholder) {
                  ...
                  // defaultValue
                  if (this._isValueWithHandlebarsTranslation(
                          sPlaceholder,
                          )) {
                    sTranslationTextKey = sPlaceholder.substring(
                        2,
                        sPlaceholder.length - 2,
                    );
                  } else if (sPlaceholder.startsWith("{i18n>")) {
                    sTranslationTextKey = sPlaceholder.substring(
                        6,
                        sPlaceholder.length - 1,
                    );
                  }
                ...
                if (this.getMode() === "translation") {
                  if (this._isValueWithHandlebarsTranslation(
                    ...
                    oItem._translatedLabel =
                        this._getCurrentLanguageSpecificText(
                            oItem.label.substring(
                                2,
                                oItem.label.length - 2,
                                ),
                            true,
                        );
        ...
        if (this.getMode() !== "translation") {
          this._initPreview().then(
              function() {
                Promise.all(this._aFieldReadyPromise)
                    .then(
                        function() {
                          this._ready = true;
                          this.fireReady();
      ...
      CardEditor.prototype._applyDesigntimeDefaults = function(oSettings) {
        ...
        for (var n in mItems) {
          var oItem = mItems[n];
          if (oItem.manifestpath) {
            oItem.value = this._manifestModel.getProperty(
                oItem.manifestpath,
            );
          }
       ...
       */
      CardEditor.prototype._addDestinationSettings = function(
          oConfiguration,
      ) {
        ...
        if (oSettings && oConfiguration && oConfiguration.destinations) {
          ...
          var oItems = oSettings.form.items;
          Object.keys(oConfiguration.destinations)
              .forEach(
                  function(n) {
                    ...
                    oItems[n + ".destinaton"] = merge(
                        {
                          manifestpath :
                              sBasePath + n + "/name", // destination points to
                          // name not value
                          visible : true,
                          type : "destination",
                          editable : true,
                          ...
                          defaultValue :
                              oConfiguration.destinations[n].defaultUrl,
                          _settingspath :
                              "/form/items/" + [ n + ".destinaton" ],
                          _values : _values,
                          _destinationName : n,
                        },
                        oConfiguration.destinations[n],
                    );
                    if (typeof oItems[n + ".destinaton"].label ===
                        "undefined") {
                      oItems[n + ".destinaton"].label = n;
                    }
                    if (oHost) {
                      oItems[n + ".destinaton"]._loading = true;
                      this._oEditorCard.getHostInstance()
                          .getDestinations()
                          .then(
                              function(n, a) {
      ...
      CardEditor._appendThemeVars = function() {
        var oOldElement = document.getElementById(
            "sap-ui-integration-editor-style",
        );
      ...
      CardEditor.init = function() {
        ...
        var sCssURL = sap.ui.require.toUrl(
            "sap.ui.integration.designtime.editor.css.CardEditor".replace(
                /\./g,
                "/",
                ) +
                ".css",

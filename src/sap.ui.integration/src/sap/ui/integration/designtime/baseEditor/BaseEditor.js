...
sap.ui.define(
    ...
    function(
      ...
      BaseEditor.prototype._prepareData = function(oJson) {
        ...
        each(
            this._mObservableConfig,
            function(sPropertyName, mPropertyConfig) {
      ...
      BaseEditor.prototype.setConfig = function(oConfig, bIsDefaultConfig) {
        ...
        this._oSetConfigPromise =
            this._oSetConfigPromise
                .then(
                    this._registerPropertyEditorTypes.bind(
                        this,
                        oConfig.propertyEditors,
                        ),
                    )
      ...
      BaseEditor.prototype._setConfig = function(
          oConfig,
          bIsDefaultConfig,
          mPropertyEditors,
      ) {
        ...
        if (this._oSpecificConfig) {
          ...
          oNewConfig = bIsDefaultConfig ? this._oSpecificConfig
                                        : mergeSpecificConfig(
                                              oNewConfig,
            ...
            this._oSetConfigPromise
                .then(
                    function() {
                      ...
                      oCurrentConfig.propertyEditors =
                          addMissingPropertyEditors(
                              oCurrentConfig,
                              oSpecificConfig,
                          );
      ...
      function mergeSpecificConfig(
          oCurrentConfig,
          oSpecificConfig,
          mPropertyEditors,
      ) {
        // merge i18n
        oCurrentConfig.i18n = _union(
            oCurrentConfig.i18n,
            oSpecificConfig.i18n,
        );
        ...
        var oNewConfig = Object.assign(
            {},
            oCurrentConfig,
            _omit(oSpecificConfig,
                  [
                    "properties",
                    "i18n",
                    "propertyEditors",
                  ]),
            _omit(oCurrentConfig,
                  [
                    "properties",
                    "i18n",
                    "propertyEditors",
        ...
        each(
            oCurrentConfig.properties,
            function(sPropertyName, oProperty) {
              var sEditor = oCurrentConfig.propertyEditors[oProperty.type] &&
              ...
              if (oConfigMetadata &&
                  oSpecificConfig.properties[sPropertyName]) {
                each(oProperty, function(sKey, vTargetValue) {
                  var vNewValue;
                  var sMergeStrategy = oConfigMetadata[sKey] &&
                                       oConfigMetadata[sKey].mergeStrategy;
                  if (sMergeStrategy) {
        ...
        if (!deepEqual(oNextMetadata, this.getDesigntimeMetadata())) {
          ...
          if (!bIsInitialMetadata) {
            this.fireDesigntimeMetadataChange({
              designtimeMetadata : this._formatExportedDesigntimeMetadata(
                  oNextMetadata,
                  ),
            });
          }
      ...
      BaseEditor.prototype._reset = function() {
        ...
        each(
            this._mPropertyEditors,
            function(sPropertyName, aPropertyEditors) {
              aPropertyEditors.forEach(function(oPropertyEditor) {
                this.deregisterPropertyEditor(
                    oPropertyEditor,
                    sPropertyName,
                );
              }, this);
          ...
          this._loadI18nBundles(mConfig.i18n)
              .then(
                  function(aBundles) {
                    ...
                    this._oConfigObserver.setModel(
                        this._oDesigntimeMetadataModel,
                        "designtimeMetadata",
                    );
                    this._oConfigObserver.setModel(
                        this._oI18nModel,
                    ...
                    if (sContextPath) {
                      ...
                      this._oConfigObserver.setBindingContext(
                          this._oDataModel.getContext(sContextPath),
                          "context",
                      );
                    }
                    ...
                    this._mObservableConfig = Object.assign(
                        this._mObservableConfig,
                        this._prepareConfig(mPropertiesConfig),
                    );
                    this._oConfigObserver.setObject(
                        this._mObservableConfig,
                    );

                    this._oConfigObserver.attachChange(
      ...
      BaseEditor.prototype._onConfigChange = function(oEvent) {
        ...
        var aPropertyEditors =
            Object.keys(oChangeMap)
                .reduce(
                    function(aList, sPropertyName) {
        ...
        var aIndependentEditors = aPropertyEditors.filter(
            function(oPropertyEditor) {
              return (!this._oRootWrapper ||
                      !includes(
                          this._oRootWrapper._aEditorWrappers,
        ...
        aIndependentEditors.forEach(function(oPropertyEditor) {
          ...
          var mPropertyConfig = _omit(
              deepClone(mProperties[sPropertyKey]),
              "value",
          );
      ...
      BaseEditor.prototype._preparePropertyConfig = function(
          mPropertyConfig,
      ) {
        var sContextPath = this._getContextPath();
      ...
      BaseEditor.prototype._createEditors = function(mPropertiesConfig) {
        var vLayoutConfig = ObjectPath.get(
            [ "layout", this.getLayout() ],
            this.getConfig(),
        );

        if (isPlainObject(vLayoutConfig) || Array.isArray(vLayoutConfig)) {
          vLayoutConfig = resolveBinding(vLayoutConfig, {
            i18n : this._oI18nModel,
          });
        }
            ...
            .all(
                values(this._mPropertyEditors)
                    .reduce(function(
                            ...
                            [])
                    .map(function(
                        oPropertyEditor) { return oPropertyEditor.ready(); }),
                )
            .then(this._checkReady.bind(this));
      };

      BaseEditor.prototype._getRegistrationKey = function(
          oPropertyEditor,
          sKey,
      ) {
      ...
      BaseEditor.prototype._addCustomProperty = function(sKey, mConfig) {
        var mObservableConfigNext = Object.assign(
            {},
            this._mObservableConfig,
        );
       ...
       *     key.
       */
      BaseEditor.prototype.registerPropertyEditor = function(
          oPropertyEditor,
          sKey,
      ) {
        ...
        oPropertyEditor.attachDesigntimeMetadataChange(
            this._onDesigntimeMetadataChange,
            this,
        );
       ...
       */
      BaseEditor.prototype.deregisterPropertyEditor = function(
          oPropertyEditor,
          sKey,
      ) {
        sKey = this._getRegistrationKey(oPropertyEditor, sKey);
      ...
      BaseEditor.prototype._checkReady = function() {
        var aLayoutDependecies = this.getContent().filter(
            function(oEditor) {
              return (
                  oEditor.isA(
                      "sap.ui.integration.designtime.baseEditor.PropertyEditors",
        ...
        aLayoutDependecies.forEach(function(oEditor) {
          if (!sap.ui.base.EventProvider.hasListener(
                  oEditor,
                  "ready",
                  this._checkReady,
                  this,
      ...
      BaseEditor.prototype._createPromise = function(fn) {
        ...
        var removeHandler = function(fnCancel, vResolvedValue) {
          this._aCancelHandlers = this._aCancelHandlers.filter(
              function(fn) { return fn !== fnCancel; },
          );
       ...
       *     label: "Foo", ... }</code>
       */
      BaseEditor.prototype.getPropertyConfigByName = function(
          sPropertyName,
      ) {
        return _omit(
            ObjectPath.get(
       ...
       */
      BaseEditor.prototype.getPropertyEditorsByName = function(
          sPropertyName,
      ) {
        return new Promise(
                   function(fnResolve) {
      ...
      BaseEditor.prototype.getPropertyEditorsByTag = function(vTag) {
        return new Promise(
            ...
            .then(
                function() { return this.getPropertyEditorsByTagSync(vTag); }
                    .bind(this),
            );
      };
      ...
      BaseEditor.prototype.getPropertyEditorsByTagSync = function(vTag) {
        return this.getPropertyEditorsSync().filter(
            function(oPropertyEditor) {

...
sap.ui.define(
    ...
    function(
          ...
          "sap.ui.integration.designtime.baseEditor.propertyEditor.mapEditor.MapEditor",
          {
            ...
            _processValue : function(mValue) {
              return Object.keys(mValue)
                  .map(
                      function(sKey) {
                        var mFormattedValue = this._prepareInputValue(
                            mValue[sKey],
                            sKey,
                        );
            ...
            _getPositions : function(mValue) {
              ...
              var aExistingPositions = aKeys.map(
                  function(sKey) {
                    var nCurrentPosition =
                        this.getNestedDesigntimeMetadataValue(
                                sKey,
                                )
                            .position;
              ...
              var mPositions = {};
              aExistingPositions.forEach(
                  function(nCurrentPosition, nIndex) {
            ...
            _prepareInputValue : function(oValue, sKey) {
              var mFormattedValue = this.processInputValue(
                  deepClone(oValue),
                  sKey,
              );
            ...
            formatItemConfig : function(oConfigValue) {
              ...
              return [
                ...
                },
                {
                  ...
                  value : sType,
                  type : "select",
                  items : this._getAllowedTypes().map(
                      function(sKey) {
                        return {
                          key : sKey,
                          title : this.getI18nProperty(
                              SUPPORTED_TYPE_LABELS[sKey],
                              ),
                        };
                      }.bind(this),
            ...
            _onRemoveElement : function(oEvent) {
              ...
              var oNewDesigntimeMetadata = deepClone(
                  this.getDesigntimeMetadata(),
              );
            ...
            _isNewItem : function(mItem) {
              return deepEqual(
                  mItem.value,
                  this._prepareInputValue(
                      this.processOutputValue(this._getItemTemplate()),
                      ),
              );
            },
            ...
            _propertyEditorsChange : function(oEvent) {
              ...
              if (Array.isArray(aPropertyEditors)) {
                aPropertyEditors.forEach(function(oPropertyEditor) {
                  oPropertyEditor.attachValueChange(
                      this._onItemChange,
                      this,
                  );
            ...
            _onTypeChange : function(sKey, oEvent) {
              ...
              if (sNewType !== sOldType) {
                var oItemToEdit = this.processInputValue(
                    oEditorValue[sKey],
                );
      ...
      MapEditor.configMetadata = Object.assign(
          {},

        ...
        var MapEditor = BasePropertyEditor.extend(
            "sap.ui.integration.designtime.baseEditor.propertyEditor.mapEditor.MapEditor",
            {
                ...
                init: function () {
                    ...
                    this.attachModelContextChange(function () {
                        if (this.getModel("i18n")) {
                            ...
                            this._aSupportedTypes = Object.keys(
                ...
                setValue: function (mValue) {
                    ...
                    this.setDesigntimeMetadata(
                        _merge(
                            ...
                            Object.keys(mPositions).reduce(function (
                                mNewMetadata,
                                sKey,
                            ) {
                                mNewMetadata[sKey] = {
                    ...
                    return Object.keys(mValue)
                        .map(function (sKey) {
                            ...
                            var oItem = {
                                ...
                                designtime:
                                    this.getNestedDesigntimeMetadata(sKey),
                            };
                ...
                _getDesigntimeMetadataValue: function (sKey) {
                    ...
                    var oDesigntimeMetadataValue =
                        oDesigntimeMetadata[sKey] || {};
                ...
                _getDefaultType: function (vValue) {
                    ...
                    var sChosenType = includes(aAllowedTypes, sType)
                        ? sType
                        : undefined;
                ...
                formatItemConfig: function (oConfigValue) {
                    ...
                    return [
                        ...
                        },
                        {
                            ...
                            type:
                                sType &&
                                includes(this._getAllowedTypes(), sType)
                                    ? sType
                ...
                _swapPositions: function (sKey1, sKey2) {
                    ...
                    oNewDesigntimeMetadata[sKey1] = {
                        __value: {
                            position:
                                this.getNestedDesigntimeMetadataValue(sKey2)
                                    .position,
                        },
                    };
                    oNewDesigntimeMetadata[sKey2] = {
                        __value: {
                            position:
                                this.getNestedDesigntimeMetadataValue(sKey1)
                                    .position,
                        },
                    };
                    this.setDesigntimeMetadata(
                ...
                _propertyEditorsChange: function (oEvent) {
                    ...
                    var aPropertyEditors =
                        oEvent.getParameter("propertyEditors");
                    if (Array.isArray(aPreviousPropertyEditors)) {
                        aPreviousPropertyEditors.forEach(function (
                ...
                _onKeyChange: function (sOldKey, oEvent) {
                    ...
                    if (sNewKey !== sOldKey) {
                        ...
                        Object.keys(oEditorValue).forEach(function (sItemKey) {
                            var sNewItemKey =
                                sItemKey === sOldKey ? sNewKey : sItemKey;
                ...
                _onTypeChange: function (sKey, oEvent) {
                    ...
                    if (sNewType !== sOldType) {
                        ...
                        oEditorValue[sKey] =
                            this.processOutputValue(oItemToEdit);

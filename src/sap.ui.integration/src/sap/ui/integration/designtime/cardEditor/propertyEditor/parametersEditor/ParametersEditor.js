...
sap.ui.define(
    [
      ...
      "sap/base/util/includes", "sap/base/util/restricted/_merge",
    ...
    function(BasePropertyEditor, MapEditor, includes, _merge, deepEqual) {
      ...
      ParametersEditor.configMetadata =
          Object.assign({}, MapEditor.configMetadata, {
            allowLabelChange :
      ...
      ParametersEditor.prototype.formatItemConfig = function(oConfigValue) {
        var oMapItemConfig =
            MapEditor.prototype.formatItemConfig.apply(this, arguments);
        ...
        var sEditable =
            (oConfigValue.value.editable || vItemMetadata.editable) !== false;
        var sManifestpath =
            oConfigValue.value.manifestpath || vItemMetadata.manifestpath || "";
        var sDescription =
            oConfigValue.value.description || vItemMetadata.description || "";
        var bTranslatable = (oConfigValue.value.translatable ||
                             vItemMetadata.translatable) === true;
        var bAllowSettings = (oConfigValue.value.allowSettings ||
                              vItemMetadata.allowSettings) !== false;
        var bAllowDynamicValues = (oConfigValue.value.allowDynamicValues ||
        ...
        oMapItemConfig.push(
            ...
            {
              label :
                  this.getI18nProperty("CARD_EDITOR.PARAMETERS.DESCRIPTION"),
              path : "description",
              value : sDescription,
              allowBindings : true,
              visible : sType !== "group",
            ...
            {
              label :
                  this.getI18nProperty("CARD_EDITOR.PARAMETERS.MANIFESTPATH"),
              path : "manifestpath",
              value : sManifestpath,
              allowBindings : true,
              visible : sType !== "group",
            ...
            {
              label :
                  this.getI18nProperty("CARD_EDITOR.PARAMETERS.TRANSLATABLE"),
              path : "translatable",
              value : bTranslatable,
              enabled : true,
              type : "boolean",
            ...
            {
              label :
                  this.getI18nProperty("CARD_EDITOR.PARAMETERS.ALLOWSETTINGS"),
              path : "allowSettings",
              allowBindings : true,
            ...
            {
              label :
                  this.getI18nProperty("CARD_EDITOR.PARAMETERS.VISUALIZATION"),
              path : "visualization",
              allowBindings : true,
      ...
      ParametersEditor.prototype.processInputValue = function(
          oValue) { return oValue; };

      ParametersEditor.prototype.processOutputValue = function(
          oValue) { return oValue; };
      ...
      ParametersEditor.prototype._isValidItem = function(oItem, oOriginalItem) {
        ...
        return (sType && includes(aAllowedTypes, sType) ||

    ...
    function(
        ...
        this._eventTimeout = setTimeout(
            function() {
              ...
              if (oJson) {
                ...
                var mParametersInDesigntime = ObjectPath.get(
                    [ "sap.card", "configuration", "parameters" ],
                ...
                if (deepEqual(mParameters, {}) && !mParametersInDesigntime) {
                  ...
                  this._oCurrent = {
                    configuration : this._cleanConfig(
                        this._oDesigntimeJSConfig,
                        ),
                    manifest : this._cleanJson(),
                    configurationclass : this._fnDesigntime,
                    configurationstring : this._cleanConfig(
                        this._oDesigntimeJSConfig,
                        true,
                        ),
                  };
                ...
                for (var n in oCopyConfig.form.items) {
                  ...
                  if (!mParameters[n]) {
                    ...
                    var vInitialValue = ObjectPath.get(
                        aPath,
                        this._oInitialJson,
                    );
                  ...
                  oCopyConfig.form.items[n] = merge(
                      oItem,
                      mParameters[n],
                  );
              ...
              var oCleanConfig = this._cleanConfig(
                  this._oDesigntimeJSConfig,
              );
              this._fnDesigntime = function(o) { return new Designtime(o); }
      ...
      BASEditor.prototype._generateMetadataFromJSConfig = function(
        ...
        if (oDesigntimeJSConfig) {
          this._oDesigntimeJSConfig = merge(
              this._oDesigntimeJSConfig,
              oDesigntimeJSConfig,
          );
        }
        ...
        if (!this._bDesigntimeInit) {
          ...
          if (sBaseUrl && sDesigntimePath) {
            ...
            mPaths[sNamespace + "js"] = sDesigntimeAbsolutePath.substring(
                0,
                sDesigntimeAbsolutePath.lastIndexOf("/"),
            );

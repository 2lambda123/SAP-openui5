                ...
                function () {
                    ...
                    if (oJson) {
                        ...
                        for (var n in oCopyConfig.form.items) {
                            ...
                            if (
                                !mParametersInDesigntime[n].__value
                                    .visualization
                            ) {
        ...
        BASEditor.prototype._cleanJson = function (oJson, bCleanParameters) {
            ...
            if (bCleanParameters) {
                ...
                for (var n in mParameters) {
                    ...
                    if (
                        this._oDesigntimeJSConfig &&
                        this._oDesigntimeJSConfig.form &&
                        this._oDesigntimeJSConfig.form.items
                    ) {
                        var oParamConfig =
                            this._oDesigntimeJSConfig.form.items[n] || {};
                        if (oParamConfig.type === "group") {
                            delete mParameters[n];
                            continue;
                        }
                        if (
                            oParamConfig.manifestpath &&
                ...
                for (var n in mItems) {
                    ...
                    if (!oMetaItem.hasOwnProperty("type")) {
                        ...
                        this.fireError({
                            ...
                            detail: {
                                message:
                                    "Type of parameter " + n + " is Invalid",
                            },
                        });
                    }
                    ...
                    if (oMetaItem.type !== "group") {
                        if (!oMetaItem.hasOwnProperty("value")) {
                            var aOtherPath = oMetaItem.manifestpath
                                    .substring(1)
                                    .split("/"),
                ...
                if (sBaseUrl && sDesigntimePath) {
                        ...
                        sap.ui.loader._.loadJSResourceAsync(sUrl)
                            .then(function (DesigntimeClass) {
                                if (!DesigntimeClass) {
                                    ...
                                    that._oDesigntimeJSConfig =
                                        oDesigntime.getSettings();
                                    that._fnDesigntime = DesigntimeClass;
                                    var oMetadata =
                                        that._generateMetadataFromJSConfig();
                                    DesigntimeClass = oDesigntime
                                        .getMetadata()
                                        .getClass();
                                    fnResolve(oMetadata);
                                }
                    ...
                    this._oDesigntimePromise.then(
                        function (oMetadata) {
                            ...
                            oDesigntimeMetadata =
                                CardMerger.mergeCardDesigntimeMetadata(
                                    oDesigntimeMetadata,
                                    this.getDesigntimeChanges(),
                                );

                            this._oInitialDesigntimeMetadata =
                                oDesigntimeMetadata;

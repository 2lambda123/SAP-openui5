...
sap.ui.define(
    ...
    function(DataProvider, jQuery, Log) {
       ...
       */
      var RequestDataProvider = DataProvider.extend(
              ...
              var oRequest = {
                ...
                method : (oRequestConfig.method &&
                          oRequestConfig.method.toUpperCase()) ||
                             "GET",
                dataType : (this.getAllowCustomDataType() &&
                            oRequestConfig.dataType) ||
                               "json",
                data : vData,
       ...
       */
      RequestDataProvider.prototype._hasHeader = function(
          oRequestConfig,
          sHeader,
          sValue,
      ) {

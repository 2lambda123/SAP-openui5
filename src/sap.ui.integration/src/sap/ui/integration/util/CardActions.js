...
sap.ui.define(
    [
      "./BindingResolver", "../library", "sap/base/Log", "sap/m/library",
      "sap/ui/util/openWindow", "sap/ui/base/ManagedObject"
    ],
    function(BindingResolver, library, Log, mLibrary, openWindow,
             ManagedObject) {
      "use strict";
       ...
       */
      var CardActions =
          ManagedObject.extend("sap.ui.integration.util.CardActions", {
            metadata : {
      ...
      CardActions.prototype._setItemTemplateTypeFormatter = function(oAction) {
        ...
        oBindingInfo.formatter = function(vValue) {
          ...
          mParameters = BindingResolver.resolveValue(oAction.parameters,
                                                     oAreaControl, sPath);
        ...
        this._oAreaControl._oServiceManager
            ...
            .then(function(oService) {
              if (oService) {
                oService.navigate({
                  // only for navigation?
                  parameters : BindingResolver.resolveValue(oAction.parameters,
                                                            oSource, sPath)
                });
              }
            })
      ...
      CardActions.prototype._attachPressEvent = function(
          oActionControl, oAction, bSingleAction) {
      ...
      CardActions.prototype._attachAction = function(mItem, oAction) {
        ...
        if (bSingleAction && oAction.service) {
          this._setSingleActionEnabledState(mItem, oAction)
              .then(function(bEnabled) {
                if (bEnabled) {
                  this._attachPressEvent(oActionControl, oAction,
                                         bSingleAction);
                }
      ...
      CardActions.prototype._processAction = function(oSource, oAction, sPath) {
        ...
        CardActions.fireAction({
          ...
          action : oAction,
          parameters :
              BindingResolver.resolveValue(oAction.parameters, oSource, sPath),
          source : oSource,
          url : sUrl
        });
      };
      ...
      CardActions._doPredefinedAction = function(mConfig) {
        ...
        case CardActionType.Submit:
          if (mConfig.source &&
              mConfig.source.isA("sap.ui.integration.cards.BaseContent")) {
      ...
      CardActions.prototype._extractActionConfigurations = function(
        ...
        return {
          ...
          configuration : {
            ...
            "xhrFields" : {"withCredentials" : !!oRequestConfig.withCredentials}
          }
        };
      };

...
sap.ui.define(
    ...
    function (
                    ...
                    oAreaControl._oServiceManager
                        ...
                        .then(function (oNavigationService) {
                            if (oNavigationService) {
                                oNavigationService
                                    .enabled({ parameters: mParameters })
        ...
        CardActions.prototype._attachAction = function (mItem, oAction) {
            var oActionControl =
                    this.getAreaType() === AreaType.ContentItem
                        ? this._oAreaControl._oItemTemplate
                        : this._oAreaControl,
                bCheckEnabledState = true,
                sAreaType = this.getAreaType(),
                bSingleAction =
                    sAreaType === AreaType.Header ||
                    sAreaType === AreaType.Content,
            ...
            if (bSingleAction && oAction.service) {
                this._setSingleActionEnabledState(mItem, oAction).then(
                    function (bEnabled) {
                        if (bEnabled) {

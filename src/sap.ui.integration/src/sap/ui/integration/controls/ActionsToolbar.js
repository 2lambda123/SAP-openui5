...
sap.ui.define(
    [
      "./ActionsToolbarRenderer", "sap/base/strings/capitalize",
      "sap/ui/core/Control", "sap/m/library", "sap/m/Button",
      "sap/m/ActionSheet", "sap/ui/base/ManagedObjectObserver",
      "sap/ui/core/Core", "sap/ui/integration/util/CardActions"

    ],
    function(ActionsToolbarRenderer, capitalize, Control, mLibrary, Button,
             ActionSheet, ManagedObjectObserver, Core, CardActions) {
      "use strict";
      /* global Map */
       ...
       */
      var ActionsToolbar =
          Control.extend("sap.ui.integration.controls.ActionsToolbar", {
            metadata : {
      ...
      ActionsToolbar.prototype.init = function() {
        ...
        this._oObserver.observe(this, {aggregations : [ "actionDefinitions" ]});
      };
      ...
      ActionsToolbar.prototype.onBeforeRendering =
          function() { this._updateVisibility(); };
      ...
      ActionsToolbar.prototype.initializeContent = function(oCard) {
        var that = this, oActionButton, aButtons = [], aActions = [],
        ...
        if (this._aButtons) {
          this._aButtons.forEach(function(oButton) { oButton.destroy(); });
        }
      ...
      ActionsToolbar.prototype.setCard = function(
          oCard) { this._oCard = oCard; };
      ...
      ActionsToolbar.prototype._getToolbar = function() {
        ...
        if (!oToolbar) {
          oToolbar = new Button({
            ...
            press : function(oEvent) { this._open(); }.bind(this)
          });
      ...
      ActionsToolbar.prototype._refreshButtons = function() {
        var aActions = this._aActions, oCard = this._oCard,
            aButtons = this._aButtons, mAction, oButton, i, aPromises = [];
        ...
        for (i = 0; i < aActions.length; i++) {
          ...
          aPromises.push(
              setButtonProperty(oButton, 'enabled', mAction.enabled, oCard));
          aPromises.push(
              setButtonProperty(oButton, 'visible', mAction.visible, oCard));
        }
      ...
      ActionsToolbar.prototype._createActionButton = function(
          vAction, bIsActionDefinition) {
        var mSettings =
            bIsActionDefinition ? this._getActionConfig(vAction) : vAction;
      ...
      ActionsToolbar.prototype._updateVisibility = function() {
        var bVisible =
            this.getAggregation("_actionSheet")
                .getButtons()
                .some(function(oButton) { return oButton.getVisible(); });
      ...
      ActionsToolbar.prototype._getActionConfig = function(oActionDefinition) {
        var mSettings = [
          "visible", "enabled", "icon", "text", "tooltip", "parameters",
          "buttonType", "type"
        ...
        mSettings.action = function() { oActionDefinition.firePress(); };
      ...
      ActionsToolbar.prototype._observeActionsAggregation = function(oChanges) {
        ...
        if (oChanges.mutation === "insert") {
          ...
          var oActionObserver =
              new ManagedObjectObserver(this._observeSingleAction.bind(this));
          oActionObserver.observe(
              oActionDefinition,
              {properties : true, aggregations : [ "tooltip" ]});
          this._mActionObservers.set(oActionDefinition.getId(),
                                     oActionObserver);
      ...
      ActionsToolbar.prototype._observeSingleAction = function(oChanges) {
        var oActionDefinition = oChanges.object, sName = oChanges.name,
            oButton =
                Core.byId(oActionDefinition.getAssociation("_menuButton")),

...
sap.ui.define(
    [
      "sap/base/util/extend", "sap/base/util/isEmptyObject",
      "sap/f/cards/NumericHeader", "sap/f/cards/NumericHeaderRenderer",
      "sap/f/cards/NumericSideIndicator", "sap/ui/model/json/JSONModel",
      "sap/ui/integration/util/LoadingProvider"
    ],
    function(extend, isEmptyObject, FNumericHeader, FNumericHeaderRenderer,
             NumericSideIndicator, JSONModel, LoadingProvider) {
      "use strict";
       ...
       */
      var NumericHeader =
          FNumericHeader.extend("sap.ui.integration.cards.NumericHeader", {
              ...
              if (mConfiguration.mainIndicator) {
                ...
                mSettings.state =
                    mConfiguration.mainIndicator
                        .state; // TODO convert ValueState to ValueColor
              }

              if (mConfiguration.sideIndicators) {
                mSettings.sideIndicators =
                    mConfiguration.sideIndicators.map(function(
                        mIndicator) { // TODO validate that it is an array and
       ...
       */
      NumericHeader.prototype.isReady = function() { return this._bReady; };
      ...
      NumericHeader.prototype._updateModel = function(

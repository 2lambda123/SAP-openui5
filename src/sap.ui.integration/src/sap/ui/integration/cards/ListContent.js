...
sap.ui.define(
    ...
    function(
       ...
       */
      var ListContent = BaseListContent.extend(
      ...
      ListContent.prototype._setItem = function(mItem) {
        ...
        if (mItem.icon) {
          mSettings.icon = BindingHelper.formattedProperty(
              mItem.icon.src,
              function(sValue) {
                return this._oIconFormatter.formatSrc(
                    sValue,
                    this._sAppId,
                );
              }.bind(this),
        ...
        if (mItem.chart) {
          mSettings.microchart = this._createChartAndAddLegend(
              mItem.chart,
          );
        }
        ...
        this._bindAggregationToControl(
            "items",
            this._getList(),
            oBindingInfo,
        );

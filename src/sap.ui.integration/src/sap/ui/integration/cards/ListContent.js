...
sap.ui.define(
    [
      "./BaseListContent", "./ListContentRenderer", "sap/ui/util/openWindow",
      "sap/m/library", "sap/m/List", "sap/ui/integration/library",
    ...
    function(BaseListContent, ListContentRenderer, openWindow, mLibrary, List,
             library, BindingHelper, Microchart, MicrochartLegend,
             ListContentItem) {
      "use strict";
       ...
       *
       * @class
       * A control that is a wrapper of a <code>sap.m.List</code> and allows its
       * creation based on a configuration.
       *
       ...
       */
      var ListContent =
          BaseListContent.extend("sap.ui.integration.cards.ListContent", {
            metadata : {
              aggregations : {
                 ...
                 */
                _legend : {multiple : false, visibility : "hidden"}
              }
            },
      ...
      ListContent.prototype.init = function() {
        ...
        this._oItemTemplate = new ListContentItem({iconDensityAware : false});
      };
       ...
       * <code>sap.ui.integration.cards.ListContent</code>.
       *
       * @public
       * @param {Object} oConfiguration Configuration object used to create the
       *     internal list.
       * @returns {sap.ui.integration.cards.ListContent} Pointer to the control
       ...
       * configuration object item template which is already parsed. Attaches
      ...
      ListContent.prototype._setItem = function(mItem) {
        var mSettings = {
          ...
          description : mItem.description &&
                            (mItem.description.value || mItem.description),
        ...
        if (mItem.icon) {
          mSettings.icon =
              BindingHelper.formattedProperty(mItem.icon.src, function(sValue) {
          ...
          mSettings.iconBackgroundColor =
              mItem.icon.backgroundColor ||
              (mItem.icon.text ? undefined : AvatarColor.Transparent);
        }
      ...
      ListContent.prototype._createChartAndAddLegend = function(
          oChartSettings) {
        ...
        if (oChartSettings.type === "StackedBar") {
          var oLegend = new MicrochartLegend({chart : oChart.getChart()});

          oLegend.initItemsTitles(oChartSettings.bars,
      ...
      /**
       * Create static StandardListItems which will be mapped with the
       * configuration that is passed.
       *
       * @private
      ...
      ListContent.prototype._setStaticItems = function(mItems) {
        ...
        mItems.forEach(function(oItem) {
          ...
          // Here can be called _attachAction so that navigation service can be
          // used
          if (oItem.action) {
       ...
       * @returns {sap.m.List} The inner list.
       */
      ListContent.prototype.getInnerList =
          function() { return this._getList(); };

...
sap.ui.define(
    ...
    function(
       ...
       */
      var TableContent = BaseListContent.extend(
      ...
      TableContent.prototype.setConfiguration = function(oConfiguration) {
        ...
        if (oConfiguration.rows && oConfiguration.columns) {
          this._setStaticColumns(
              oConfiguration.rows,
              oConfiguration.columns,
          );
          return this;
        }
        ...
        if (oColumn.identifier) {
          ...
          if (oColumn.identifier.url) {
            ...
            oIdentifier.attachTitlePress(function(oEvent) {
              ...
              sUrl = BindingResolver.resolveValue(
                  oColumn.identifier.url,
                  oSource,
                  sPath,
              );
              sTarget = BindingResolver.resolveValue(
                  oColumn.identifier.target,
                  oSource,
                  sPath,
              );

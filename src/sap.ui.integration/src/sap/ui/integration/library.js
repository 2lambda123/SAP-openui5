...
sap.ui.define(
    [
      "sap/ui/base/DataType", "sap/ui/Global",
      // library dependency
      "sap/ui/core/library", "sap/m/library", "sap/f/library"
    ],
    function(DataType) {
      "use strict";
      ...
      sap.ui.getCore().initLibrary({
        ...
        types : [
          ...
          "sap.ui.integration.CardDataMode", "sap.ui.integration.CardMenuAction"
        ],
        controls : [
          "sap.ui.integration.widgets.Card", "sap.ui.integration.cards.Header",
          "sap.ui.integration.cards.NumericHeader",
          "sap.ui.integration.controls.ListContentItem"
        ],
        elements : [
          "sap.ui.integration.ActionDefinition", "sap.ui.integration.Host"
        ],
       ...
       * Disclaimer: this property is in a beta state - incompatible API changes
       * may be done before its official public release. Use at your own
       * discretion.
      ...
      /**
       * Possible data modes for <code>{@link
       * sap.ui.integration.widgets.Card}</code>.
       *
       * @enum {string}
       ...
       * @property {sap.ui.integration.CardActionType} type The type of the
       * action.
       ...
       * @property {boolean|function} enabled If the action is enabled. Default
       * value is <code>true</code>.
       * @property {boolean|function} visible If the action is visible. Default
       * value is <code>true</code>.
       ...
       * (legacy) designtime metamodel
       */
      thisLib.CardMenuAction =
          DataType.createType("sap.ui.integration.CardMenuAction", {
            isValid : function(oValue) {
              var aPossibleKeys = [
                "type", "text", "icon", "tooltip", "buttonType", "enabled",
                "visible", "action", "parameters", "target",
                "url" // do not document these as they should not be used
              ];
              return Object.keys(oValue).every(function(
                  sKey) { return aPossibleKeys.indexOf(sKey) !== -1; });
            }
          },
                              "object");

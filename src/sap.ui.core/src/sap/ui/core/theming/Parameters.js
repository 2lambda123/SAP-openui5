...
sap.ui.define(
    ...
    function (URI, Element, UriParameters, Log, extend, ThemeCheck, jQuery) {
        ...
        if (
            oCfgData["xx-nosync"] === "warn" ||
            /(?:\?|&)sap-ui-xx-nosync=(?:warn)/.exec(window.location.search)
        ) {
            syncCallBehavior = 1;
        }
        if (
            oCfgData["xx-nosync"] === true ||
            oCfgData["xx-nosync"] === "true" ||
            /(?:\?|&)sap-ui-xx-nosync=(?:x|X|true)/.exec(window.location.search)
        ) {
            syncCallBehavior = 2;
        }
        ...
        function checkAndResolveRelativeUrl(sUrl, sThemeBaseUrl) {
            ...
            if (aMatch) {
                ...
                if (oUri.is("relative")) {
                    ...
                    // incorrect
                    var sNormalizedUrl = oUri
                        .absoluteTo(sThemeBaseUrl)
                        .normalize()
                        .toString();
        ...
        function loadParameters(sId) {
            ...
            // relative urls)
            var sThemeBaseUrl = new URI(sStyleSheetUrl)
                .filename("")
                .query("")
                .toString();
        ...
        function loadParametersJSON(sUrl, sThemeBaseUrl, aWithCredentials) {
            ...
            jQuery.ajax({
                ...
                success: function (data, textStatus, xhr) {
                    ...
                    var sThemeOrigin = new URI(sThemeBaseUrl).origin();
                    mOriginsNeedingCredentials[sThemeOrigin] =
        ...
        function getParam(mOptions) {
            ...
            if (
                mOptions.loadPendingParameters &&
                typeof sParam === "undefined"
            ) {
        ...
        Parameters.getActiveScopesFor = function (oElement) {
            ...
            if (oElement instanceof Element) {
                ...
                if (domRef) {
                    ...
                    while (domRef) {
                        var aFoundScopeClasses =
                            aScopes.filter(fnNodeHasStyleClass);
                    ...
                    var fnControlHasStyleClass = function (sScopeName) {
                        return (
                            typeof oElement.hasStyleClass === "function" &&
                    ...
                    while (oElement) {
                        ...
                        oElement =
                            typeof oElement.getParent === "function" &&
                            oElement.getParent();
                    }
                }
            }

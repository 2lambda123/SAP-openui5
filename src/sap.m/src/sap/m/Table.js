...
sap.ui.define(
    ...
    function(
       ...
       */
      var Table = ListBase.extend(
          "sap.m.Table",
          /** @lends sap.m.Table.prototype */ {
            metadata : {
              library : "sap.m",
              properties : {
                /**
      ...
      Table.prototype.setContextualWidth = function(sWidth) {
        ...
        // validate the value
        var bWidthValidated = this._validateContextualWidth(
            this._sContextualWidth,
        );
      ...
      Table.prototype._validateContextualWidth = function(sWidth) {
        ...
        if (typeof sWidth != "string") {
          throw new Error(
              'expected string for property "contextualWidth" of ' + this,
          );
        }
      ...
      Table.prototype._registerResizeHandler = function() {
        if (!this._iResizeHandlerId) {
          ...
          window.requestAnimationFrame(function() {
            that._iResizeHandlerId = ResizeHandler.register(
                that,
                that._onResize.bind(that),
            );
          });
        }
      };
       ...
       * @protected
       */
      Table.prototype._hasDynamicWidthColumn = function(
          oColumn,
          sColumnWidth,
      ) {
      ...
      Table.prototype.onItemTypeColumnChange = function(
          oItem,
          bNeedsTypeColumn,
      ) {
      ...
      Table.prototype.onItemSelectedChange = function(oItem, bSelect) {
        ...
        setTimeout(
            function() { this.updateSelectAllCheckbox(); }.bind(this),
            0,
        );
      };
          ...
          if (!hasPopin) {
            ...
            setTimeout(
                function() {
                  ...
                  var bHideColumn = aHiddenInPopin.some(
                      function(sImportance) { return !!sImportance; },
                  );
                  if (bHideColumn) {
                    this._firePopinChangedEvent();
                  }
       ...
       * @protected
       */
      Table.prototype.enhanceAccessibilityState = function(
          oElement,
          mAriaProps,
      ) {
       ...
       * @protected
       */
      Table.prototype.getColCount = function() { return this._colCount || 0; };
      ...
      Table.prototype.onpaste = function(oEvent) {
        ...
        var aData = PasteHelper.getPastedDataAs2DArray(
            oEvent.originalEvent,
        );
        if (
            !aData || aData.length === 0 /* no rows pasted */ ||
      ...
      Table.prototype._configureAutoPopin = function(bRecalculate) {
        var aVisibleColumns = this.getColumns(true).filter(
            function(oColumn) { return oColumn.getVisible(); },
        );
        ...
        if (bRecalculate) {
          ...
          fAccumulatedWidth = Table._updateAccumulatedWidth(
              aMedCols,
              aHighCols.length === 0 && aMedCols.length > 0,
              fAccumulatedWidth,
          );
          Table._updateAccumulatedWidth(
              aLowCols,
              aHighCols.length === 0 && aMedCols.length === 0 &&
                  aLowCols.length > 0,
              fAccumulatedWidth,
       ...
       * @private
       */
      Table._updateAccumulatedWidth = function(
          aCols,
          bSkipPopinForFirst,
          fAccumulatedWidth,
      ) {
        ...
        for (var i = 0; i < aCols.length; i++) {
          ...
          var sUnit = sWidth.replace(/[^a-z]/gi, "");
      ...
      Table.prototype._getHiddenInPopin = function() {
        var aVisiblePopinColumns = this.getColumns().filter(
            function(oColumn) {
              return oColumn.getVisible() && oColumn.getDemandPopin();
            },
        );

        var aHiddenPopinColumns = aVisiblePopinColumns.filter(
            function(oVisibleColumn) {
      ...
      Table.prototype._setFirstLastVisibleCells = function(oDomRef) {
        ...
        for (var oLast = oDomRef.lastChild.previousSibling;
             oLast && !oLast.clientWidth; oLast = oLast.previousSibling) {
          /* empty */
        }

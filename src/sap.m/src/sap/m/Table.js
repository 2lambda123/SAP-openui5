...
sap.ui.define(
    ...
    function (
        ...
        Table.prototype._hasDynamicWidthColumn = function (
            ...
            return this.getColumns().some(function (oCurrentColumn) {
                if (oCurrentColumn.getVisible()) {
                    var sWidth =
                        oColumn && oColumn == oCurrentColumn
                            ? sColumnWidth
        ...
        Table.prototype.setTableHeaderVisibility = function (bColVisible) {
            ...
            if (aVisibleColumns.length == 1) {
                ...
                aVisibleColumns.each(function () {
                    this.style.width =
                        this.getAttribute("data-sap-width") || "";
                });
            }
        ...
        Table.prototype._setTypeColumnVisibility = function (bVisible) {
            jQuery(this.getTableDomRef()).toggleClass(
                "sapMListTblHasNav",
                bVisible,
            );
        ...
        Table.prototype.updateSelectAllCheckbox = function () {
            ...
            if (this._selectAllCheckBox && this.getMode() === "MultiSelect") {
                ...
                this._selectAllCheckBox.setSelected(
                    aItems.length > 0 &&
                        iSelectedItemCount == iSelectableItemCount,
                );
            }
        };
        ...
        Table.prototype.isHeaderRowEvent = function (oEvent) {
            var $Header = this.$("tblHeader");
            return !!jQuery(oEvent.target).closest(
                $Header,
                this.getTableDomRef(),
            ).length;
        };
        ...
        Table.prototype._setHeaderAnnouncement = function () {
            var oBundle = Core.getLibraryResourceBundle("sap.m"),
                sAnnouncement =
                    oBundle.getText("ACC_CTR_TYPE_HEADER_ROW") + " ";
            ...
            this.getColumns(true).forEach(function (oColumn, i) {
                ...
                if (oHeader && oHeader.getVisible()) {
                    sAnnouncement +=
                        ListItemBase.getAccessibilityText(oHeader) + " ";
                }
            });
        ...
        Table.prototype._setFooterAnnouncement = function () {
            ...
            this.getColumns(true).forEach(function (oColumn, i) {
                ...
                if (oFooter && oFooter.getVisible()) {
                    ...
                    sAnnouncement +=
                        ListItemBase.getAccessibilityText(oFooter) + " ";
                }
            });
        ...
        Table.prototype.onsaptabnext = function (oEvent) {
            ...
            var oLastTabbableDomRef =
                $Row.find(":sapTabbable").get(-1) || $Row[0];
        ...
        Table._updateAccumulatedWidth = function (
            ...
            for (var i = 0; i < aCols.length; i++) {
                ...
                if (sUnit === "" || sUnit === "auto") {
                    ...
                    fAutoPopinWidth =
                        fAutoPopinWidth + aCols[i].getAutoPopinWidth();
                } else if (sUnit === "px") {
                    ...
                    fAutoPopinWidth =
                        ...
                        parseFloat(
                            (
                                parseFloat(sWidth).toFixed(2) / sBaseFontSize
                            ).toFixed(2),
                        );
        ...
        Table.prototype._getHiddenInPopin = function () {
            ...
            var aHiddenPopinColumns = aVisiblePopinColumns.filter(
                function (oVisibleColumn) {
                    return (
                        oVisibleColumn._media &&
                        !oVisibleColumn._media.matches &&
        ...
        Table.prototype._setFirstLastVisibleCells = function (oDomRef) {
            ...
            $DomRef
                .find(".sapMTblLastVisibleCell")
                .removeClass("sapMTblLastVisibleCell");
            $DomRef
                .find(".sapMTblFirstVisibleCell")
                .removeClass("sapMTblFirstVisibleCell");
            for (
                var oFirst = oDomRef.firstChild;
                oFirst && !oFirst.clientWidth;
                oFirst = oFirst.nextSibling
            ) {
                /* empty */
            }
            for (
                var oLast = oDomRef.lastChild.previousSibling;

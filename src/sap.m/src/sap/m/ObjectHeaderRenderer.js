...
sap.ui.define(
    ...
    function (
        ...
        ObjectHeaderRenderer._isEmptyObject = function (oObject) {
            ...
            if (
                (!oObject._isEmpty || !oObject._isEmpty()) &&
        ...
        ObjectHeaderRenderer._isEmptyRow = function (oLeft, aRight) {
            return (
                ObjectHeaderRenderer._isEmptyObject(oLeft) &&
            ...
            if (oOH.getStatuses()) {
                ...
                for (var i = 0; i < aStatuses.length; i++) {
                    if (!aStatuses[i].getVisible || aStatuses[i].getVisible()) {
                        if (
                            (aStatuses[i] instanceof sap.m.ObjectStatus &&
        ...
        ObjectHeaderRenderer._renderAttributesAndStatuses = function (
            ...
            var iNoOfRows =
                iAttribsLength > iMarkersAndStatusesLength
                    ? iAttribsLength
        ...
        ObjectHeaderRenderer._renderTitle = function (oRM, oOH) {
            ...
            if (
                oOH.getShowTitleSelector() &&
                oOH._oTitleArrowIcon.getVisible()
            ) {
                oRM.openStart("div");
            ...
            if (oOH.getTitle()) {
                var sTitleLevel =
                    oOH.getTitleLevel() === TitleLevel.Auto
                        ? TitleLevel.H1
                        : oOH.getTitleLevel();
        ...
        ObjectHeaderRenderer._renderResponsive = function (oRM, oOH) {
            ...
            if (
                ...
                oOH._isMediaSize("Desktop") &&
                oOH.getFullScreenOptimized() &&
                oOH._iCountVisAttrStat >= 1 &&
            ...
            if (
                oHeaderContainer &&
                oHeaderContainer instanceof sap.m.IconTabBar
            ) {
        ...
        ObjectHeaderRenderer._renderResponsiveTitleBlock = function (
            ...
            // Title container displayed to the left of the number and number units
            // container.
            oRM.openStart("div", oControl.getId() + "-titlenumdiv"); // Start Title and Number container
            // (block1 and block2)
        ...
        ObjectHeaderRenderer._renderResponsiveRow = function (oRM, oOH) {
            ...
            if (
                (Device.system.tablet && !Device.system.desktop) ||
        ...
        ObjectHeaderRenderer._renderResponsiveStatesColumn = function (
            ...
            var iCurrentCountInCol = 0; // contains current number of attributes and statuses in the
            ...
            for (var i = 0; i < aVisibleAttrAndStat.length; i++) {
                ...
                iCurrentCountInCol++;
                if (
                    (iCurrentCountInCol == iCountInCols &&
        ...
        ObjectHeaderRenderer._renderResponsiveMarkers = function (
            ...
            if (
                (sTextDir === TextDirection.LTR && bPageRTL) ||
            ...
            if (oHeaderContainer) {
                if (oHeaderContainer instanceof sap.m.IconTabBar) {
                    ...
                    if (oIconTabHeader.getVisible()) {
                        oControl._iCountVisTabs =
                            oIconTabHeader.getItems().length;
        ...
        ObjectHeaderRenderer._renderResponsiveTitleAndArrow = function (
            ...
            var sOHTitle,
                sEllipsis = "",
                sTextDir = oOH.getTitleTextDirection();

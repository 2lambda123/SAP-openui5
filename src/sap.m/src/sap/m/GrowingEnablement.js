            ...
            /** @lends sap.m.GrowingEnablement.prototype */ {
                ...
                onAfterRendering: function () {
                    ...
                    if (oControl.getGrowingScrollToLoad()) {
                        var oScrollDelegate =
                            library.getScrollDelegate(oControl);
                        if (oScrollDelegate) {
                ...
                reset: function () {
                    ...
                    this._oControl.oExtendedChangeDetectionConfig =
                        !oBindingInfo || !oBindingInfo.template
                            ? null
                            : { replace: true };
                },
                ...
                shouldReset: function (sChangeReason) {
                    ...
                    return (
                        sChangeReason == mChangeReason.Sort ||
                ...
                onScrollToLoad: function () {
                    var oTriggerButton =
                        this._oControl.getDomRef("triggerList");
                    ...
                    if (
                        this._oControl.getGrowingDirection() ==
                ...
                requestNewPage: function () {
                    ...
                    if (
                        (oBinding && !oBinding.isLengthFinal()) ||
                        ...
                        if (
                            this._oControl
                                .getMetadata()
                                .hasProperty("enableBusyIndicator")
                        ) {
                ...
                _getHasScrollbars: function () {
                    ...
                    // be scrollable
                    return (
                        this._oScrollDelegate.getMaxScrollTop() >
                ...
                addListItem: function (
                    ...
                    if (oBinding.isGrouped()) {
                        ...
                        if (
                            ...
                            var oGroupHeader = oBindingInfo.groupHeaderFactory
                ...
                applyChunk: function (vInsert, oDomRef) {
                    ...
                    if (this._oControl.isA("sap.m.Table")) {
                        var bHasVisibleColumn = this._oControl
                            .getColumns()
                            .some(function (oColumn) {
                    ...
                    if (
                        ...
                        if (vInsert === true) {
                            ...
                            vInsert =
                                this._iRenderedDataItems - iLength - vInsert;
                        }
                    }
                ...
                refreshItems: function (sChangeReason) {
                    ...
                    if (
                        !this._iLimit ||
                        this.shouldReset(sChangeReason) ||
                        !this._oControl.getItems(true).length
                    ) {
                        this._iLimit = this._oControl.getGrowingThreshold();
                    }
                ...
                updateItems: function (sChangeReason) {
                    ...
                    if (!aContexts.length) {
                        ...
                        if (
                            this._sGroupingPath !=
                            this._getGroupingPath(oBinding)
                        ) {
                            ...
                            for (var i = 0; i < aDiff.length; i++) {
                                ...
                                if (
                                    ...
                                    oDiff.index != this._iRenderedDataItems
                                ) {
                ...
                _updateTrigger: function (bLoading) {
                    ...
                    if (bLoading) {
                        ...
                        var aItems = oControl.getItems(true),
                            ...
                            bHasScrollToLoad =
                                oControl.getGrowingScrollToLoad(),

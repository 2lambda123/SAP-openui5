...
sap.ui.define(
    ...
    function(
      ...
      var GrowingEnablement = BaseObject.extend(
          ...
          /** @lends sap.m.GrowingEnablement.prototype */ {
            ...
            render : function(oRm) {
              oRm.openStart(
                  "div",
                  this._oControl.getId() + "-triggerList",
              );
            ...
            _onBeforePageLoaded : function(sChangeReason) {
              this._bLoading = true;
              this._oControl.onBeforePageLoaded(
                  this.getInfo(),
                  sChangeReason,
              );
            },
            ...
            _onAfterPageLoaded : function(sChangeReason) {
              this._bLoading = false;
              this._updateTriggerDelayed(false);
              this._oControl.onAfterPageLoaded(
                  this.getInfo(),
                  sChangeReason,
              );
                      ...
                      .addDelegate(
                          {
                            ...
                            onAfterRendering : function(oEvent) {
                              ...
                              // type="Active" aria-selected should be removed
                              // as it is not allowed with role="button"
              ...
              if (oBinding.isGrouped()) {
                ...
                if (!oLastItem ||
                    oGroupInfo.key !==
                        oBinding
                            .getGroup(
                                oLastItem.getBindingContext(sModelName),
                                )
                            .key) {
                  var oGroupHeader =
            ...
            rebuildListItems : function(
              ...
              if (bSuppressInvalidate) {
                var bHasFocus = this._oContainerDomRef.contains(
            ...
            insertListItem : function(oContext, oBindingInfo, iIndex) {
              ...
              this._oControl.insertAggregation(
                  "items",
                  oItem,
                  iIndex,
                  true,
            ...
            updateItems : function(sChangeReason) {
              ...
              if (bFromScratch) {
                ...
                this.updateItemsBindingContext(
                    aContexts,
                    oBindingInfo.model,
                );
                this.applyChunk(vInsertIndex);
            ...
            _updateTrigger : function(bLoading) {
              ...
              if (bLoading) {
                ...
                if (!iItemsLength || !this._iLimit ||
                  ...
                  if (oControl.isA("sap.m.Table") && !oControl.hasPopin() &&
                    ...
                    var sCalWidth =
                        Array
                            .from(
                                oControl.getDomRef("tblHeader").childNodes,
                                )
                            .slice(0, -1)
                            .map(function(oDomRef) {
                              var sWidth = oDomRef.getAttribute(
                                  "data-sap-width",
                              );
                ...
                if (iItemsLength > 0 && this._oScrollPosition) {
                  ...
                  oScrollDelegate.scrollTo(
                      oScrollPosition.left,
                      oScrollDelegate.getScrollHeight() - oScrollPosition.top,
                  );
      ...
      GrowingEnablement.createItem = function(
          oContext,
          oBindingInfo,
          sIdSuffix,
      ) {

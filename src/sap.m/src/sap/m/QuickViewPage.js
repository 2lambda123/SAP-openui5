...
sap.ui.define(
    ...
    function(
      ...
      var QuickViewPage = Control.extend(
          "sap.m.QuickViewPage",
          /** @lends sap.m.QuickViewPage.prototype */ {
            metadata : {
              library : "sap.m",
              properties : {
                /**
      ...
      QuickViewPage.prototype._createPage = function() {
        ...
        if (this._oPage) {
          ...
          oPage = this._oPage = new Page(
              mNavContext.quickViewId + "-" + this.getPageId(),
        ...
        if (sIcon) {
          if (this.getIcon().indexOf("sap-icon") == 0) {
            ...
            if (IconPool.isIconURI(sFallbackIcon)) {
              oFallbackIcon = this._createIcon(
                  sFallbackIcon,
                  !sTitleUrl,
                  sTitle,
              );
          ...
          if (sTitleUrl) {
            ...
            if (oFallbackIcon) {
              oFallbackIcon.attachPress(
                  this._crossApplicationNavigation(this),
              );
            }
          }
       ...
       * @private
       */
      QuickViewPage.prototype._createIcon = function(
          sIconSrc,
          bDecorative,
          sTooltip,
      ) {
      ...
      QuickViewPage.prototype._renderGroup = function(oGroup, oForm) {
        ...
        for (var k = 0; k < aElements.length; k++) {
          ...
          if (oCurrentGroupElement.getType() ==
            ...
            oCurrentGroupElementValue.attachPress(
                this._attachPressLink(this),
            );
          }
      ...
      ["setModel",
       ...
       "destroyAggregation",
        ...
        QuickViewPage.prototype[sFuncName] = function() {
          var result = QuickViewPage.prototype["_" + sFuncName + "Old"].apply(
              this, arguments);
      ...
      QuickViewPage.prototype._onImageLoadError = function(oEvent) {
        ...
        oFallbackIcon.removeStyleClass(

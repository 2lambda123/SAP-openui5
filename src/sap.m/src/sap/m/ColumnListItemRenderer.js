...
sap.ui.define(
    ...
    function(
          ...
          if (oColumn) {
            ...
            if (!oTable.hasPopin() && oColumn.getMergeDuplicates()) {
              ...
              if (typeof oCell[sFuncName] != "function") {
                Log.warning(
                    "mergeFunctionName property is defined on " + oColumn +
                        " but this is not function of " + oCell,
                );
      ...
      ColumnListItemRenderer.renderPopin = function(rm, oLI, oTable) {
        ...
        rm.attr(
            "colspan",
            oTable.shouldRenderDummyColumn() ? oTable.getColSpan() + 1
                                             : oTable.getColSpan(),
        );
      ...
      ColumnListItemRenderer.renderContentLatter = function(rm, oLI) {
        ...
        if (oTable && oTable.shouldRenderDummyColumn()) {
          if (!oTable.hasPopin()) {
            ListItemBaseRenderer.renderContentLatter.apply(
                this,
                arguments,
            );

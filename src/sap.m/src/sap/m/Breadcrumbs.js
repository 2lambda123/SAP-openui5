...
sap.ui.define(
    ...
    function (
        ...
        Breadcrumbs.prototype._decorateSelect = function (oSelect) {
            ...
            oSelect._onBeforeOpenDialog =
                this._onSelectBeforeOpenDialog.bind(this);
...
change and we shouldn't act on it */
        ...
        Breadcrumbs.prototype._getItemsToNavigate = function () {
            var aItemsToNavigate =
                    this._getControlsForBreadcrumbTrail().slice(),

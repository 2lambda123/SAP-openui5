...
sap.ui.define(
    ...
    function(
      ...
      Breadcrumbs.prototype.onAfterRendering = function() {
        if (!this._sResizeListenerId) {
          this._sResizeListenerId = ResizeHandler.register(
              this,
      ...
      Breadcrumbs.prototype.insertLink = function(oLink, iIndex) {
        var vResult = this.insertAggregation.apply(
            this,
            fnConvertArguments("links", arguments),
        );
     ...
     change and we shouldn't act on it */
       ...
       */
      Breadcrumbs.prototype._updateSelect = function(
          bInvalidateDistribution,
      ) {
        ...
        oSelect.setVisible(
            !!oControlsDistribution.aControlsForSelect.length,
        );
      ...
      Breadcrumbs.prototype._getControlsInfo = function() {
        if (!this._bControlsInfoCached) {
          ...
          this._aControlInfo = this._getControlsForBreadcrumbTrail().map(
      ...
      Breadcrumbs.prototype._handleScreenResize = function(oEvent) {
        ...
        oControlsDistribution = this._getControlDistribution(
            Math.ceil(getElementWidth(this.$())),
        );
        iCalculatedControlsForBreadcrumbTrailCount =
      ...
      Breadcrumbs.prototype._configureKeyboardHandling = function() {
        ...
        oItemNavigation.setPageSize(
            Breadcrumbs.PAGEUP_AND_PAGEDOWN_JUMP_SIZE,
        );

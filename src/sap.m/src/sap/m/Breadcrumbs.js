...
sap.ui.define(
    [
      "sap/ui/core/Control", "sap/ui/util/openWindow", "sap/m/Text",
      "sap/m/Link", "sap/m/Select", "sap/ui/core/Item",
      "sap/ui/core/delegate/ItemNavigation", "sap/ui/core/ResizeHandler",
      "sap/ui/core/IconPool", "sap/ui/Device", "sap/m/library",
      "./BreadcrumbsRenderer"
    ],
    function(Control, openWindow, Text, Link, Select, Item, ItemNavigation,
             ResizeHandler, IconPool, Device, library, BreadcrumbsRenderer) {
      "use strict";
       ...
       *
       * @class
       * Enables users to navigate between items by providing a list of links to
       * previous steps in the user's navigation path. The last three steps can
       * be accessed as links directly, while the remaining links prior to them
       * are available in a drop-down menu.
       *
       * @see {@link
       *     fiori:https://experience.sap.com/fiori-design-web/breadcrumb/
       *     Breadcrumbs}
       *
      ...
      var Breadcrumbs = Control.extend("sap.m.Breadcrumbs", {
        metadata : {
          ...
          properties : {
            ...
            /**
             * Determines the text of current/last element in the Breadcrumbs
             * path.
             * @since 1.34
             */
            currentLocationText :
            ...
            /**
             * Determines the visual style of the separator between the
             * <code>Breadcrumbs</code> elements.
             * @since 1.69
             */
            separatorStyle : {
          ...
          aggregations : {
            ...
            /**
             * A list of all the active link elements in the Breadcrumbs
             * control. <b>Note:</b> Enabling the property <code>wrapping</code>
             * of the link will not work since it's incompatible with the
             * concept of the control. The other properties will work, but their
             * effect may be undesirable.
             * @since 1.34
             */
            links :
                {type : "sap.m.Link", multiple : true, singularName : "link"},

            /**
             * Private aggregations
             */
            _currentLocation :
                {type : "sap.m.Text", multiple : false, visibility : "hidden"},
            _select :
                {type : "sap.m.Select", multiple : false, visibility : "hidden"}
          },
      ...
      Breadcrumbs.prototype.init = function() {
        this._sSeparatorSymbol =
            Breadcrumbs.STYLE_MAPPER[this.getSeparatorStyle()];
      };
      ...
      Breadcrumbs.prototype.onAfterRendering = function() {
        if (!this._sResizeListenerId) {
          this._sResizeListenerId =
              ResizeHandler.register(this, this._handleScreenResize.bind(this));
        }
      ...
      Breadcrumbs.prototype.onThemeChanged =
          function() { this._resetControl(); };
      ...
      Breadcrumbs.prototype._getAugmentedId = function(
          sSuffix) { return this.getId() + "-" + sSuffix; };
      ...
      Breadcrumbs.prototype._getSelect = function() {
        if (!this.getAggregation("_select")) {
          this.setAggregation("_select", this._decorateSelect(new Select({
            ...
            tooltip : BreadcrumbsRenderer._getResourceBundleText(
                "BREADCRUMB_SELECT_TOOLTIP")
          })),
                              true);
        }
      ...
      Breadcrumbs.prototype._getCurrentLocation = function() {
        if (!this.getAggregation("_currentLocation")) {
          ...
          this.setAggregation("_currentLocation", oCurrentLocation)
              .addStyleClass("sapMBreadcrumbsCurrentLocation");
        }
      ...
      Breadcrumbs.prototype.insertLink = function(oLink, iIndex) {
        var vResult = this.insertAggregation.apply(
            this, fnConvertArguments("links", arguments));
      ...
      Breadcrumbs.prototype.addLink = function(oLink) {
        var vResult = this.addAggregation.apply(
            this, fnConvertArguments("links", arguments));
        this._registerControlListener(oLink);
        this._resetControl();
        return vResult;
      ...
      Breadcrumbs.prototype.removeLink = function(vObject) {
        var vResult = this.removeAggregation.apply(
            this, fnConvertArguments("links", arguments));
      ...
      Breadcrumbs.prototype.removeAllLinks = function() {
        ...
        var vResult = this.removeAllAggregation.apply(
            this, fnConvertArguments("links", arguments));
      ...
      Breadcrumbs.prototype.destroyLinks = function() {
        var aLinks = this.getAggregation("links", []);
        var vResult = this.destroyAggregation.apply(
            this, fnConvertArguments("links", arguments));
        aLinks.forEach(this._deregisterControlListener, this);
        this._resetControl();
        return vResult;
      ...
      Breadcrumbs.prototype._decorateSelect = function(oSelect) {
        ...
        oSelect._onBeforeOpenPopover =
            this._onSelectBeforeOpenPopover.bind(this);
        oSelect.onsapescape = this._onSelectEscPress.bind(this);

        return oSelect;
      };

      Breadcrumbs.prototype._removeItemNavigation =
          function() { this.removeDelegate(this._getItemNavigation()); };
      ...
      Breadcrumbs.prototype._restoreItemNavigation =
          function() { this.addDelegate(this._getItemNavigation()); };

      Breadcrumbs.prototype._onSelectEscPress =
          function() { this._getSelect().close(); };
      ...
      Breadcrumbs.prototype._createSelectItem = function(oItem) {
        return new Item({key : oItem.getId(), text : oItem.getText()});
      };
      ...
      Breadcrumbs.prototype._selectChangeHandler = function(oEvent) {
        var oLink, sLinkHref, sLinkTarget,
            oSelectedItem = oEvent.getParameter("selectedItem");

        /* there's no selected item, nothing to do in this case (the selected
         * item is often set to null) */
        if (!oSelectedItem) {
          return;
        }
        ...
        /* if it's not a link, then it must be only the current location text,
        ...
        if (sLinkHref) {
          if (sLinkTarget) {
            // TODO: take oLink.getRel() value into account ('links' is a public
            // aggregation)
      ...
      Breadcrumbs.prototype._updateSelect = function(bInvalidateDistribution) {
        var oSelect = this._getSelect(), aControlsForSelect,
            oControlsDistribution = this._getControlDistribution();

        if (!this._bControlDistributionCached || bInvalidateDistribution) {
          oSelect.destroyItems();
          aControlsForSelect = Device.system.phone
                                   ? this._getItemsForMobile()
                                   : oControlsDistribution.aControlsForSelect;
          aControlsForSelect.map(this._createSelectItem)
              .reverse()
              .forEach(oSelect.insertItem, oSelect);
      ...
      Breadcrumbs.prototype._getControlsForBreadcrumbTrail = function() {
        ...
        aVisibleControls = this.getLinks().filter(function(
            oLink) { return oLink.getVisible(); });
      ...
      Breadcrumbs.prototype._determineControlDistribution = function(
          iMaxContentSize) {
        var index, oControlInfo,
            aControlInfo = this._getControlsInfo().aControlInfo,
            iSelectWidth = this._getSelectWidth(), aControlsForSelect = [],
            aControlsForBreadcrumbTrail = [],
            iUsedSpace = iSelectWidth; // account for the selectWidth initially;

        // The rightmost controls should go into overflow first, hence iterating
        // the controls in reverse
        for (index = aControlInfo.length - 1; index >= 0; index--) {
          ...
          // we've reached the last item and we've not used a select then we
          // will not need to take it into account
          if (index === 0) {
      ...
      /**
       * Stores the sizes and other info of controls so they don't need to be
       * recalculated again until they change.
       * @private
      ...
      Breadcrumbs.prototype._getControlsInfo = function() {
        if (!this._bControlsInfoCached) {
          this._iSelectWidth =
              getElementWidth(this._getSelect().$().parent()) || 0;
          this._aControlInfo =
              this._getControlsForBreadcrumbTrail().map(this._getControlInfo);
          // ceil the container width to prevent unnecessary overflow of a link
          // due to rounding issues (when the available space appears
          // insufficient with less than a pixel
      ...
      Breadcrumbs.prototype._handleScreenResize = function(oEvent) {
        var iCachedControlsForBreadcrumbTrailCount, oControlsDistribution,
        ...
        iCachedControlsForBreadcrumbTrailCount =
            this._oDistributedControls.aControlsForBreadcrumbTrail.length;
        // ceil the container width to prevent unnecessary overflow of a link
        // due to rounding issues (when the available space appears insufficient
        // with less than a pixel
        oControlsDistribution =
            this._getControlDistribution(Math.ceil(getElementWidth(this.$())));
        iCalculatedControlsForBreadcrumbTrailCount =
            oControlsDistribution.aControlsForBreadcrumbTrail.length;

        if (iCachedControlsForBreadcrumbTrailCount !==
            iCalculatedControlsForBreadcrumbTrailCount) {
          this._updateSelect(true);
        }
      ...
      Breadcrumbs.prototype._configureKeyboardHandling = function() {
        var oItemNavigation = this._getItemNavigation(), iSelectedDomIndex = -1,
      ...
      /**
       * Every time a control is inserted in the breadcrumb, it must be
       * monitored for size/visibility changes
       * @param oControl
       * @private
       */
      ...
      /**
       * Resets all of the internally cached values used by the control and
       * invalidates it
       *
       * @returns {object} this
       * @private

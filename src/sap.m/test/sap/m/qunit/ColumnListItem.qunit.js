    ...
    function(
      ...
      QUnit.test(
          ...
          function(assert) {
            ...
            assert.strictEqual(
                sut._aClonedHeaders.length,
                1,
                "Popin has cloned header",
            );
            assert.strictEqual(
                sut.$Popin().find(".sapMListTblSubRowCell").length,
                1,
                "sapMListTblSubRowCell added to popin cell",
            );
            assert.strictEqual(
                sut.$Popin().find(".sapMListTblSubCntHdr").length,
                1,
                "Popin header is found in the dom",
            );
            assert.strictEqual(
                sut.$Popin().find(".sapMListTblSubCntSpr").length,
                1,
                "Popin separator is found in the dom",
            );
            assert.strictEqual(
                sut.$Popin().find(".sapMListTblSubCntVal").length,
                1,
      ...
      QUnit.test(
          "RenderOulineClassButNotLegacyOutlineClass",
          function(assert) {
            ...
            // Assert
            assert.ok(
                sut.$().hasClass("sapMLIBFocusable"),
                "Outline class is added",
            );
            assert.ok(
                !sut.$().hasClass("sapMLIBLegacyOutline"),
      ...
      QUnit.test("Test for correct column id", function(assert) {
        ...
        assert.equal(
            $td.getAttribute("data-sap-ui-column"),
            oCol.getId(),
      ...
      QUnit.test(
          ...
          function(assert) {
            assert.ok(
                this.sut.$().find(".sapMListTblDummyCell").length > 0,

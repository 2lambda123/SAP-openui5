sap.ui.define(
    [
      'sap/base/util/deepExtend', 'sap/ui/core/mvc/Controller',
    ...
    function(deepExtend, Controller, JSONModel) {
      ...
      var TableController =
          Controller.extend("sap.m.sample.TableColumnWidth.Table", {
            ...
            onReset : function(
                oEvent) { this.oColumnModel.setData(this.oData); },

            onCheckBoxSelect : function(oEvent) {
              var bStrictLayout = oEvent.getParameter("selected");
              this.byId("table").setFixedLayout(bStrictLayout ? "Strict"
                                                              : true);
            },

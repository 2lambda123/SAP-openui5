    ...
    function (
        ...
        Field.prototype._handleModelContextChange = function (oEvent) {
            ...
            if (oBinding) {
                ...
                if (
                    Context.hasChanged(this._oBindingContext, oBindingContext)
                ) {
        ...
        function _updateCondition(vValue, vAdditionalValue) {
            ...
            if (this._checkValueInitial(vValue) && !vAdditionalValue) {
                ...
                var sOldAdditionalValue =
                    aConditions[0] && aConditions[0].values[1]
                        ? aConditions[0].values[1]
                        : null; // to compare with default value
                if (
                    !aConditions[0] ||
                    aConditions[0].operator !== "EQ" ||
                    ...
                    oCondition.validated = ConditionValidated.Validated; // see every value set from outside as validated
        ...
        function _compareValues(vValue1, vValue2, bUpdateCheck) {
            ...
            if (
                ...
                Array.isArray(vValue1) &&
                Array.isArray(vValue2)
            ) {
        ...
        function _initializeType(vValue) {
            if (!this._bTypeInitialized) {
                ...
                var oBinding = this.getBinding("value");
                var oDataType = oBinding ? oBinding.getType() : this._oDataType; // use type from binding, not internal
                ...
                this._bTypeInitialized =
                    this._oTypeInitialization.bTypeInitialized;
        ...
        function _updateValue(aConditions) {
            ...
            if (
                vAdditionalValue !== vOldAdditionalValue &&
                !_checkAdditionalValueOneWay.call(this)
            ) {
                // to run not in V4 update issues if data not already loaded

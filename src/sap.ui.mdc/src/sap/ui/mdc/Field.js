...
sap.ui.define(
    ...
    function(
      ...
      var Field = FieldBase.extend(
          "sap.ui.mdc.Field",
          /* @lends sap.ui.mdc.Field.prototype */ {
            metadata : {
              library : "sap.ui.mdc",
              properties : {
                /**
      ...
      Field.prototype.bindProperty = function(sName, oBindingInfo) {
        if (sName === "value" && !oBindingInfo.formatter) {
          // not if a formatter is used, as this
      ...
      Field.prototype._handleModelContextChange = function(oEvent) {
        FieldBase.prototype._handleModelContextChange.apply(
            this,
            arguments,
        );
        ...
        if (oBinding) {
          var oBindingContext = oBinding.isA(
      ...
      function _adjustValue(vValue, vOldValue) {
        ...
        if (vValue && vOldValue &&
          ...
          if (this._bPendingChange) {
            // change is pending because navigated
      ...
      Field.prototype._fireChange = function(
          aConditions,
          bValid,
          vWrongValue,
          oPromise,
        ...
        if (aConditions) {
          // even if empty and error is returned, only in async
      ...
      Field.prototype._getOperators = function() { return [ "EQ" ]; };

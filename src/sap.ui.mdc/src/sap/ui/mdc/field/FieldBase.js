    ...
    function (
        ...
        FieldBase._init = function () {
            ...
            if (
                mDefaultHelps &&
                mDefaultHelps.bool &&
                mDefaultHelps.bool.control
            ) {
                mDefaultHelps.bool.control.destroy();
            }
            if (
                mDefaultHelps &&
                mDefaultHelps.defineConditions &&
        ...
        FieldBase.prototype.exit = function () {
            ...
            if (
                this._oConditionsType &&
                this._oConditionsType._bCreatedByField
            ) {
        ...
        FieldBase.prototype.onsapup = function (oEvent) {
            ...
            if (
                oFieldHelp &&
                (!this._bIsMeasure || oSource.getShowValueHelp())
            ) {
        ...
        function _adjustDataTypeForUnit() {
            ...
            var sName = oType.getMetadata().getName();
            var oFormatOptions = oType.oFormatOptions;
            var oConstraints = isEmptyObject(oType.oConstraints)
                ? undefined
                : oType.oConstraints;
            ...
            if (
                !oFormatOptions ||
                !oFormatOptions.hasOwnProperty("showMeasure") ||
                ...
                if (oType.hasOwnProperty("bParseAsString")) {
                    oFormatOptions.parseAsString = oType.bParseAsString; // as V4 types set it always to true and
                    // uses internal value
                }
        ...
        FieldBase.prototype._observeChanges = function (oChanges) {
            ...
            if (
                oChanges.name === "dataTypeFormatOptions" ||
            ...
            if (oChanges.name === "conditions") {
                this._bParseError = false; // if conditions updated from outside parse error is
                ...
                // empty-indicator)
                if (
                    (oChanges.current.length === 0 ||
                        oChanges.old.length === 0) &&
                    this.getShowEmptyIndicator() &&
                    this.getEditMode() === EditMode.Display &&
                    !this.getContent() &&
        ...
        function _ariaLabelledByChanged(sId, sMutation) {
            ...
            for (var i = 0; i < aContent.length; i++) {
                oContent = aContent[i];
                if (
                    oContent.getMetadata().getAllAssociations().ariaLabelledBy
                ) {
                    if (sMutation === "remove") {
        ...
        function _contentChanged(oContent, sMutation, sName) {
            if (sMutation === "remove") {
                ...
                for (var sAggregation in oContent
                    .getMetadata()
                    .getAllAggregations()) {
                    if (
                        oContent.getBindingPath(sAggregation) === "/conditions"
                    ) {
                        oBindingInfo = oContent.getBindingInfo(sAggregation);
                        if (oBindingInfo && oBindingInfo.template) {
                            for (sProperty in oBindingInfo.template
                                .getMetadata()
                                .getAllProperties()) {
                                ...
                                if (
                                    oTemplateBindingInfo &&
                                    oTemplateBindingInfo.type &&
                                    oTemplateBindingInfo.type instanceof
                                        ConditionType
                                ) {
                                    this._oContentConditionTypes[
                                        sName
        ...
        function _setUsedConditionType() {
            ...
            if (
                this._oConditionType &&
                !this._oConditionType._bCreatedByField
            ) {
                this._oConditionType = undefined;
            }
            if (
            ...
            if (this.getContent()) {
                ...
                if (this._oContentConditionTypes.contentDisplay) {
                    oConditionType =
                        this._oContentConditionTypes.contentDisplay
                            .oConditionType;
                    oConditionsType =
                        this._oContentConditionTypes.contentDisplay
                            .oConditionsType;
                ...
                if (this._oContentConditionTypes.contentEdit) {
                    ...
                    oConditionsType =
                        this._oContentConditionTypes.contentEdit
                            .oConditionsType;
                }
            }
        ...
        function _createInternalContent() {
            ...
            _checkFieldHelpExist.call(this, this.getFieldHelp()); // as FieldHelp might be greated after
            ...
            if (sControlName !== sControlNameOld) {
                ...
                if (!MyControl) {
                    if (mControls[sControlName].promise) {
                        ...
                        mControls[sControlName].promise = new Promise(
                            function (fResolve) {
        ...
        function _createUnitInputControls(Input, sId) {
            ...
            var oInput1 = new Input(sId, {
                ...
                width: "70%",
                tooltip: "{$field>/tooltip}",
                fieldGroupIds: [this.getId()], // use FieldGroup to fire change only if focus
        ...
        function _createDefaultFieldHelp(sType) {
            ...
            if (!oFieldHelp) {
                ...
                if (!FieldHelp && !mDefaultHelps[sType].promise) {
                    mDefaultHelps[sType].promise = new Promise(
                        function (fResolve) {
                ...
                if (FieldHelp) {
                    var oDelegate =
                        ...
                        this.getControlDelegate()[
                            mDefaultHelps[sType].getDelegate
                        ]();
        ...
        function _useDefaultFieldHelp(
            ...
            if (
                oControlType.useDefaultFieldHelp &&
                !this.getFieldHelp() &&
                sEditMode !== EditMode.Display
            ) {
                if (aOperators.length === 1) {
                    ...
                    if (iMaxConditions === 1) {
                        ...
                        oControlType.useDefaultFieldHelp.oneOperatorMulti ||
                        !bIsSingleValue
                    ) {
                ...
                if (oChange.waitForUpdate && Array.isArray(oChange.result)) {
                    if (oChange.result.length === 0 && vValue === "") {
                        ...
                        for (var j = 0; j < oChange.result.length; j++) {
                            ...
                            if (
                                deepEqual(oCondition.values[0], vValue) ||
        ...
        function _performContentChange(oChange) {
            ...
            var bChangeIfNotChanged = false; // in SearchField case fire change even if value not changed.
            ...
            var oBinding =
                this._sBoundProperty &&
                oSource.getBinding(this._sBoundProperty);
            if (
                oBinding &&
                oBinding.getBindingMode() !== BindingMode.OneWay &&
                oBinding.getPath() === "/conditions" &&
                bValid
            ) {
            ...
            if (bUpdateConditions) {
                ...
                oCondition = SyncPromise.resolve()
                    .then(
                        function () {
                            var iMaxConditions = this.getMaxConditions();
                ...
                !oChange.changeEvent.parameters.hasOwnProperty("valid") &&
                this._bParseError
            ) {
            ...
            if (bValid) {
                if (oCondition) {
                    ...
                    if (
                        ...
                        if (
                            iMaxConditions > 0 &&
                            iMaxConditions <= aConditions.length
                        ) {
        ...
        function _handleContentLiveChange(oEvent) {
            ...
            if (
                ...
                if (bEscPressed) {
                    ...
                    var aOperators = this._getOperators(); // show suggestion only if equal operators
                    // are supported
                    ...
                    if (bUseFieldHelp) {
                        this._bIgnoreInputValue = false; // after typing the input value is the current one and
                        // should be used
                            ...
                            this._fnLiveChangeTimer = debounce(
                                function () {
                                    ...
                                    if (this._vLiveChangeValue) {
                                        // use EQ operator
                                        var oOperator =
                                            FilterOperatorUtil.getEQOperator();
                                    ...
                                    if (
                                        ...
                                        if (
                                            this.getMaxConditionsForHelp() ===
                                                1 &&
                                            oFieldHelp.getConditions().length >
                                                0
                                        ) {
                        ...
                        var vOpenByTyping = oFieldHelp.openByTyping(); // trigger determination of search
                        // functionality
        ...
        function _handleTokenUpdate(oEvent) {
            if (oEvent.getParameter("type") === "removed") {
                ...
                this.setProperty("conditions", aConditions, true); // do not invalidate whole field
                _executeChange.call(this, aConditions, true); // removing Token don't need to wait for
        ...
        function _handleFieldHelpSelect(oEvent) {
            ...
            if (this._bIsMeasure) {
                ...
                if (aConditions.length > 0) {
                    ...
                    for (i = 0; i < aConditions.length; i++) {
                        aConditions[i].values[0][1] =
                            aNewConditions[0].values[0];
                        if (aConditions[i].operator === "BT") {
                            aConditions[i].values[1][1] =
                                aNewConditions[0].values[0];
                        }
                        if (aNewConditions[0].inParameters) {
                            aConditions[i].inParameters =
                                aNewConditions[0].inParameters;
                        }
                        if (aNewConditions[0].outParameters) {
                            aConditions[i].outParameters =
                                aNewConditions[0].outParameters;
                        }
                    }
                } else {
                    oCondition = merge({}, aNewConditions[0]); // use selected condition to keep
                    // in/out parameter
                    ...
                    if (this._oConditionType) {
                        sDOMValue =
                            this._oConditionType.formatValue(oCondition);
                    } else if (this._oConditionsType) {
                        sDOMValue =
                            this._oConditionsType.formatValue(aConditions);
                    }
                }
            } else {
                if (!bAdd) {
            ...
            if (oContent && oContent.setDOMValue) {
                if (
                    this.getMaxConditionsForHelp() === 1 &&
                    ...
                    if (this._bIsMeasure && this._oUnitConditionsType) {
                        sDOMValue =
                            this._oUnitConditionsType.formatValue(aConditions);
                    ...
                    if (sDOMValue instanceof Promise) {
                        ...
                        sDOMValue.then(function (sText) {
                            oContent.setDOMValue(""); // to overwrite it even if the text is the same ->
                    ...
                    this._bIgnoreInputValue = true; // after something is selected, the value just stays for
            ...
            if (!deepEqual(aConditions, aConditionsOld)) {
                ...
                if (
                    !FilterOperatorUtil.compareConditionsArray(
                        aConditions,
                        aConditionsOld,
                    )
                ) {
        ...
        function _handleFieldHelpNavigate(oEvent) {
            ...
            this._bPreventGetDescription = true; // if no description in navigated condition, no description
        ...
        function _handleHelpDataUpdate(oEvent) {
            var isEditing =
                this.getEditMode() === EditMode.Editable &&
        ...
        function _handleInfoDataUpdate() {
            ...
            oFieldInfo.isTriggerable().then(function (bTriggerable) {
                ...
                if (
                    that.getAggregation("_content", []).length > 0 &&
        ...
        FieldBase.prototype._getFormatOptions = function () {
            if (!this._asyncParsingCall) {
                this._asyncParsingCall = _asyncParsingCall.bind(this); // as variable to have the same function after each update
            ...
            return {
                ...
                originalDateType:
                    this._oDateOriginalType || this._oUnitOriginalType,
                display: this._bIsMeasure
                    ? FieldDisplay.Value
                    : this.getDisplay(),
                ...
                bindingContext: this.getBindingContext(), // to dertmine text and key usding
        ...
        FieldBase.prototype._checkValueInitial = function (vValue) {
            ...
            if (
                ...
                var sDataType = _getDataTypeName.call(this);
                if (
                    this.getTypeUtil().getBaseType(sDataType) ===
                        BaseType.Unit &&

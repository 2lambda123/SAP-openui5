...
sap.ui.define(
    ...
    function(jQuery, Device, EditMode, FieldDisplay, FieldBaseRenderer,
             FilterOperatorUtil, Condition, ConditionType, ConditionsType,
             BaseType, DateUtil, coreLibrary, Control, LabelEnablement,
             MessageMixin, ObjectPath, deepEqual, merge, Log, isEmptyObject,
             containsOrEquals, Filter, BindingMode, FormatException,
             ParseException, ValidateException, ManagedObjectModel,
             ManagedObjectObserver, SyncPromise, debounce, KeyCodes) {
      "use strict";
       ...
       *
       * @class
       * A <code>FieldBase</code> control is the basic control to be used within
       * the <code>Field</code> and <code>FilterField</code> controls. It must
       ...
       */
      var FieldBase = Control.extend(
          "sap.ui.mdc.field.FieldBase",
          /* @lends sap.ui.mdc.field.FieldBase.prototype */ {
            metadata : {
              ...
              properties : {
                 ...
                 */
                dataTypeConstraints :
                    {type : "object", group : "Data", defaultValue : null},
                ...
                /**
                 * Determines whether the field is editable, read-only, or
                 * disabled.
                 */
                editMode : {
                 ...
                 */
                required :
                    {type : "boolean", group : "Data", defaultValue : false},
                ...
                /**
                 * Defines whether the value and/or description of the field is
                ...
                /**
                 * Defines the horizontal alignment of the text that is shown
                 * inside the input field.
                 *
                 * <b>Note:</b> If the rendered control doesn't support this
                 * feature, this property is ignored.
                 */
                textAlign : {
                ...
                /**
                 * Defines the text directionality of the input field, for
                 * example <code>RTL</code>, <code>LTR</code>.
                 *
                 * <b>Note:</b> If the rendered control doesn't support this
                 * feature, this property is ignored.
                 */
                 ...
                 * when the control has no value. If the value is
                 * <code>null</code> no placeholder is shown.
                 *
                 * <b>Note:</b> If the rendered control doesn't support this
                 * feature, this property is ignored.
                 */
                ...
                /**
                 * Visualizes the validation state of the control, for example
                 * <code>Error</code>, <code>Warning</code>,
                 * <code>Success</code>.
                 *
                 * <b>Note:</b> The visualization of the <code>ValueState</code>
                 * property is handled by the inner rendered control. If a
                 * control is set (using <code>content</code>,
                 * <code>contentEdit</code>, or <code>contentDisplay</code>),
                 * this control needs to support the <code>valueState</code>
                 * behavior, otherwise <code>valueState</code> is not
                 * visualized.
                 */
                valueState : {
                ...
                /**
                 * Defines the text that appears in the value state message
                 * pop-up. If this has not specified, a default text from the
                 * resource bundle is shown.
                 */
                valueStateText :
                ...
                /**
                 * If set, the <code>Field</code> is rendered using a multi-line
                 * control.
                 *
                 * This property only affects types that support multiple lines.
                 *
                 * <b>Note</b> If the data type used doesn't support multiple
                 * lines an error is thrown.
                 */
                multipleLines : {
                  type : "boolean",
                  group : "Appearance",
                ...
                /**
                 * Sets the maximum amount of conditions that are allowed for
                 * this field.
                 *
                 * The default value of -1 indicates that an unlimited amount of
                 * conditions can be defined.
                 *
                 * <b>Note</b> If the data type used doesn't support multiple
                 * conditions, an error is thrown.
                 */
                maxConditions :
                    {type : "int", group : "Behavior", defaultValue : -1},

                /**
                 * Sets the conditions that represent the values of the field.
                 *
                 * This should be bound to a <code>ConditionModel</code> using
                 * the corresponding fieldPath.
                 *
                 * <b>Note</b> For <code>FilterField</code> controls, the
                 * <code>conditions</code> property must be used to bind
                 * <code>FilterField</code> to a
                 * <code>ConditionModel</code>.</br> For example, for a
                 * <code>FilterField</code> control inside a
                 * <code>FilterBar</code> control the binding looks like this:
                 * <code>conditions="{$filters>/conditions/propertyPath}"</code>
                 * with the following data: <ul> <li><code>$filters</code> as
                 * the name of the condition model</li>
                 * <li><code>/conditions/</code> as a required static part of
                 * the binding</li> <li><code>propertyPath</code> as the
                 * property name</li>
                 * </ul>
                 *
                 * For an Any (see {@link sap.ui.model.FilterOperator})
                 * <code>FilterField</code> control, the binding looks like
                 * this:
                 * <code>conditions='{$filters>/conditions/navPath&#42;/propertyPath}'</code>
                 * with the following data: <ul> <li><code>$filters</code> as
                 * the name of the condition model</li>
                 * <li><code>/conditions/</code> as a required static part of
                 * the binding</li> <li><code>navPath#42;/</code> as the
                 * navigation property name</li> <li><code>propertyPath</code>
                 * as the property name</li>
                 * </ul>
                 * Between <code>navPath</code> and <code>propertyPath</code>,
                 * <b>&#42;/</b> is required.
                 */
                conditions : {
                  type : "object[]",
                 ...
                 *
                 * This can be used by <code>FilterBar</code> or
                 * <code>Form</code> controls to create a <code>Label</code>
                 * control for the field.
                 *
                 * @experimental
                 * @since 1.62.0 Disclaimer: this property is in a beta state -
                 * incompatible API changes may be done before its official
                 * public release. Use at your own discretion.
                 */
                label : {type : "string", group : "Misc", defaultValue : ""},

                /**
                 * Path to <code>FieldBaseDelegate</code> module that provides
                 * the required APIs to execute model-specific logic.<br>
                 * <b>Note:</b> Ensure that the related file can be requested
                 * (any required library has to be loaded before that).<br> Do
                 * not bind or modify the module. Once the required module is
                 * associated, this property might not be needed any longer.
                 *
                 * @since 1.72.0
                 * @experimental
                 */
                ...
                /**
                 * If set, an empty <code>Field</code> renders an
                 * empty-indicator in display mode.
                 *
                 * This property only takes effect if <code>editMode</code> is
                 * set to <code>Display</code>.
                 *
                 * <b>Note</b> Empty means the <code>Field</code> holds no
                 * value. If an empty string is a valid value, the
                 * <code>Field</code> might show nothing, depending on the
                 * <code>display</code> settings and assigned description or
                 * <code>FieldHelp</code>.
                 *
                 * @since 1.85.0
                 */
                ...
                /**
                 * Internal property to bind the <code>showValueHelp</code>
                 * property of the internal <code>Input</code> control.
                 */
                _fieldHelpEnabled : {
                  type : "boolean",
                  group : "Appearance",
                 ...
                 *
                 * The object contains ARIA attribudes in an <code>aria</code>
                 * node. Additional attributes, such as <code>role</code> or
                 * <code>autocomplete</code>, are added on root level.
                 */
                _ariaAttributes : {
                  type : "object",
                  defaultValue : {},
              ...
              aggregations : {
                 ...
                 *
                 * <b>Note:</b> Bind the value-holding property of the control
                 * to <code>'$field>/conditions'</code> using
                 * <code>sap.ui.mdc.field.ConditionsType</code> as type.
                 *
                 * If the control needs to show multiple conditions, bind its
                 * aggregation to </code>'$field>/conditions'</code>. Bind the
                 * item controls value-holding property using
                 * <code>sap.ui.mdc.field.ConditionType</code> as type.
                 *
                 * <b>Warning:</b> Only controls allowed in a </code>Form</code>
                 * are allowed to be used for this optional content. Other
                 * controls might break the layout. This means the
                 * <code>sap.ui.core.IFormContent</code> interface needs to be
                 * implemented by these controls.
                 */
                content : {type : "sap.ui.core.Control", multiple : false},

                /**
                 * Optional content to be rendered if the <code>editMode</code>
                 * property is not set to <code>Display</code>.
                 *
                 * <b>Note:</b> If a control is assigned to the
                 * <code>content</code> aggregation, this one is ignored.
                 *
                 * <b>Note:</b> Bind the value-holding property of the control
                 * to <code>'$field>/conditions'</code> using
                 * <code>sap.ui.mdc.field.ConditionsType</code> as type.
                 ...
                 * are allowed to be used for this optional content. Other
                 * controls might break the layout. This means the
                 * <code>sap.ui.core.IFormContent</code> interface needs to
                 * implemented by these controls.
                 *
                 * @since 1.61.0
                 */
                contentEdit : {type : "sap.ui.core.Control", multiple : false},

                /**
                 * Optional content to be rendered  if the <code>editMode</code>
                 * property is set to <code>Display</code>.
                 *
                 * <b>Note:</b> If a control is assigned to the
                 * <code>content</code> aggregation, this one is ignored.
                 *
                ...
                /**
                 * Optional <code>FieldInfo</code> used for detail information.
                 * This is only active in display mode.
                 *
                 * <b>Note:</b> If a special data type is defined or a content
                 * control is set, this is ignored.
                 */
                fieldInfo :
                    {type : "sap.ui.mdc.field.FieldInfoBase", multiple : false}
              },
              associations : {
                /**
                 ...
                 * <code>FieldHelp</code> instance for multiple fields.
                 *
                 * <b>Note:</b> If the field is inside of a table, do not set
                 * the <code>FieldHelp</code> instance as <code>dependent</code>
                 * to the field. If you do every field instance in every table
                 * row gets a clone of it. Put the <code>FieldHelp</code>
                 * instance e.g. as dependent on the table or page. The
                 * <code>FieldHelp</code> instance must be somewhere in the
                 * control tree, otherwise there might be rendering or update
                 * issues.
                 *
                 * <b>Note:</b> For Boolean fields, no <code>FieldHelp</code>
                 * should be added, but a default <code>FieldHelp</code> used
                 * instead.
                 */
                fieldHelp :
                    {type : "sap.ui.mdc.field.FieldHelpBase", multiple : false},

                /**
                 * Association to controls / IDs that label this control (see
                 * WAI-ARIA attribute aria-labelledby).
                 */
                ariaLabelledBy : {
                  type : "sap.ui.core.Control",
                  multiple : true,
              ...
              events : {
                /**
                 * This event is fired when the value of the field is changed,
                 * for example, each time a key is pressed.
                 *
                 * <b>Note</b> This event is only triggered if the used content
                 * control has a <code>liveChange</code> event.
                 */
                liveChange : {
                  parameters : {
                    /**
                ...
                /**
                 * This event is fired if the inner control has a
                 * </code>press</code> event and this is fired.
                 */
                press : {},
                /**
                 ...
                 *
                 * <b>Note</b> This event is only triggered if the field is
                 * editable.
                 *
                 * @since 1.82.0
                 */
                submit : {
                  parameters : {
                    /**
                     * Returns a <code>Promise</code> for the change. The
                     * <code>Promise</code> returns the value if it is resolved.
                     * If the last <code>change</code> event is synchronous, the
                     * <code>Promise</code> has already been resolved. If it is
                     * asynchronous, it will be resolved after the value has
                     * been updated.
                     */
      ...
      // apply the message mixin so all message on the input will get the
      // associated label-texts injected
      ...
      var mControlTypes = {
        Default : {
          ...
          useDefaultFieldHelp : {
            name : "defineConditions",
            oneOperatorSingle : false,
            oneOperatorMulti : false
          }, // if no FieldHelp and multiple operators use default FieldHelp
        ...
        Date : {
          edit : "sap/ui/mdc/field/FieldInput",
          editMulti : [
            "sap/ui/mdc/field/FieldMultiInput", "sap/m/Token"
          ], // FieldHelp needed to enter date
          display : "sap/m/Text",
          editOperator : {
            "EQ" : {
              name : "sap/m/DatePicker",
              create : _createDatePickerControl
            }, // TODO: how to check custom operators
            "BT" : {
              name : "sap/m/DateRangeSelection",
              create : _createDateRangePickerControl
            }
          },
          createEdit : _createInputControl,
          createEditMulti :
              _createMultiInputControl, // FieldHelp needed to enter date
          createDisplay : _createTextControl,
          useDefaultFieldHelp : {
            name : "defineConditions",
            oneOperatorSingle : false,
            oneOperatorMulti : true
          }, // if no FieldHelp and multiple operators use default FieldHelp
          defaultEnterHandler : true
        },
        Time : {
      ...
      var oContentEventDelegateAfter = {onsapenter : _handleEnter};
      ...
      FieldBase._init = function() {
        ...
        if (mDefaultHelps && mDefaultHelps.defineConditions &&
            mDefaultHelps.defineConditions.control) {
      ...
      FieldBase.prototype.init = function() {
        ...
        this._oObserver =
            new ManagedObjectObserver(this._observeChanges.bind(this));

        this._oObserver.observe(this, {
          properties : [
            "display", "editMode", "dataType", "dataTypeFormatOptions",
            "dataTypeConstraints", "multipleLines", "maxConditions",
            "conditions", "delegate"
          ],
          aggregations :
              [ "fieldInfo", "content", "contentEdit", "contentDisplay" ],
        ...
        this._oResourceBundle =
            sap.ui.getCore().getLibraryResourceBundle("sap.ui.mdc");

        this._aAsyncChanges = [];

        this._bPreventGetDescription =
            false; // set in navigate or select from field help
      };
      ...
      FieldBase.prototype.setProperty = function(sPropertyName, oValue,
                                                 bSuppressInvalidate) {
        // most properties are rendered from content controls. Only invalidate
        // whole Field if needed (multipleLines mostly changed together with
        // editMode -> update once om rendering)
        if (sPropertyName !== "width" && sPropertyName !== "editMode" &&
            sPropertyName !== "multipleLines" &&
            sPropertyName !== "showEmptyIndicator") {
          bSuppressInvalidate = true;
        }

        return Control.prototype.setProperty.apply(
            this, [ sPropertyName, oValue, bSuppressInvalidate ]);
      };
      ...
      FieldBase.prototype.onBeforeRendering = function() {
        if (!this.bDelegateInitialized) {
          ...
          this.awaitControlDelegate().then(
              function() { _createInternalContent.call(this); }.bind(this));
          return;
        }
      ...
      function _validateFieldGroup(oEvent) {
        ...
        if (aFieldGroup.indexOf(this.getId()) > -1) { // own FieldGroup left
          ...
          if (this._bPendingChange) {
            ...
            var oFieldHelp = _getFieldHelp.call(this);
            if (!(oFocusedElement && oFieldHelp &&
                  containsOrEquals(oFieldHelp.getDomRef(), oFocusedElement))) {
              var oPromise = _getAsyncPromise.call(this);

              if (oPromise) {
                _executeChange.call(this, undefined, undefined, undefined,
                                    oPromise);
              } else {
                _executeChange.call(this, this.getConditions(),
                                    !this._bParseError);
              }
            }
          }
      ...
      FieldBase.prototype.onsapenter = function(oEvent) {
        // if same value is entered again no change event is triggered, So we
        // need to close the suggestion here
        var oFieldHelp = _getFieldHelp.call(this);
      ...
      FieldBase.prototype.ontap = function(oEvent) {
        ...
        var oFieldHelp = _getFieldHelp.call(this);
        if (oFieldHelp && oFieldHelp.openByClick() &&
            !oFieldHelp.isOpen(true)) {
      ...
      FieldBase.prototype.clone = function(sIdSuffix, aLocalIds) {
        ...
        this.detachEvent("modelContextChange", this._handleModelContextChange,
                         this);
       ...
       *
       * If the <code>conditions</code> are bound to a
       * <code>ConditionModel</code>, the <code>FieldPath</code> is determined
       * from this binding.
       *
      ...
      function _triggerChange(aConditions, bValid, vWrongValue, oPromise) {
        ...
        if (this._getContent().length > 1) {
          // in unit/currency field fire Change only if ENTER pressed or field
          // completely left. Not on focus between number and unit
      ...
      function _executeChange(aConditions, bValid, vWrongValue, oPromise) {
        ...
        if (!oPromise) {
          // not promise -> change is synchronously -> return resolved
          // SyncPromise
          if (bValid) {
      ...
      function _handleEnter(oEvent) {
        ...
        if (_getEditable(sEditMode) &&
            (this.hasListeners("submit") || this._bPendingChange)) {
          // collect all pending promises for ENTER, only if all resolved it's
          // not pending. (Normally there should be only one.)
          var oPromise = _getAsyncPromise.call(this);
          var bPending = false;
          ...
          if (oPromise) {
            ...
            oPromise = Promise.resolve(
                this._getResultForPromise(this.getConditions()));
          }
          ...
          if (this._bPendingChange) {
            if (bPending) {
              ...
              _executeChange.call(this, this.getConditions(),
                                  !this._bParseError, undefined, oPromise);
            }
          }
      ...
      function _getDataType() {
        ...
        if (!this._oDataType) {
          ...
          if (typeof sDataType === "string") {
            this._oDataType = this.getTypeUtil().getDataTypeInstance(
                sDataType, this.getDataTypeFormatOptions(),
      ...
      function _getDataTypeName() {
        ...
        if (this._oDataType && typeof this._oDataType === "object") {
          ...
          return this.getControlDelegate().getDataTypeClass(this.getPayload(),
                                                            this.getDataType());
        } else {
      ...
      function _getDataTypeFormatOptions() {
        ...
        if (this._oDataType && typeof this._oDataType === "object" &&
            this._oDataType.oFormatOptions) {
      ...
      /*
       * To avoid data loss for DatePicker (e.g. in short Year number foe 1918)
       * use ISO format as ValueFormat in DatePickers
       */
      function _getDatePattern(sType, oFormatOptions, oConstraints) {

        var sBaseType =
            this.getTypeUtil().getBaseType(sType, oFormatOptions, oConstraints);
      ...
      function _adjustDataTypeForDate() {
        ...
        // if type is used from binding (Field) or format options are not set
        // correctly -> create new type
        _getDatePattern.call(this, sName, oFormatOptions,
                             oConstraints); // to determine pattern
        if (!oFormatOptions || oFormatOptions.style ||
          ...
          this._oDataType =
              DateUtil.createInternalType(oType, this._sValueFormat);
      ...
      function _adjustDataTypeForUnit() {
        ...
        var oFormatOptions = oType.oFormatOptions;
        var oConstraints =
            isEmptyObject(oType.oConstraints) ? undefined : oType.oConstraints;

        // if type is used from binding (Field) or format options are not set
        // correctly -> create new type
        if (!oFormatOptions || !oFormatOptions.hasOwnProperty("showMeasure") ||
            oFormatOptions.showMeasure) {
          oFormatOptions =
              merge({}, oFormatOptions); // do not manipulate original object
          oFormatOptions.showMeasure = false;
          oFormatOptions.strictParsing =
              true; // do not allow to enter unit in number field
          if (oType.hasOwnProperty("bParseAsString")) {
            oFormatOptions.parseAsString =
                oType.bParseAsString; // as V4 types set it always to true and
                                      // uses internal value
          }
          if (oFormatOptions.customCurrencies) {
            delete oFormatOptions
                .customCurrencies; // cannot be set from outside
          }
          ...
          this.getControlDelegate().initializeInternalUnitType(
              this.getPayload(), this._oDataType, this._oTypeInitialization);
          _updateConditionType.call(this);
        }
      }
      ...
      function _getEditable(sEditMode) {
        ...
        if (sEditMode === EditMode.Editable ||
            sEditMode === EditMode.EditableReadOnly ||
            sEditMode === EditMode.EditableDisplay) {
          return true;
        } else {
          return false;
        }
       ...
       * Observes changes.
       *
       * To be enhanced by <code>Field</code>, </code>FilterField</code>, or
      ...
      FieldBase.prototype._observeChanges = function(oChanges) {
        ...
        if (oChanges.name === "dataType") {
          // check only if different type (in Field type might be already taken
          // from biding)
          if (this._oDataType) {
            var fnCheck = function(sType) {
              var oTypeClass =
                  this.getTypeUtil().getDataTypeClass(oChanges.current);
            ...
            if (!this.bDelegateInitialized) {
              // wait until delegate is loaded
              this.awaitControlDelegate().then(
                  function() { fnCheck.call(this, oChanges.current); }.bind(
                      this));
              return;
            }
        ...
        if (oChanges.name === "dataTypeFormatOptions" ||
            oChanges.name === "dataTypeConstraints") {
        ...
        if (oChanges.name === "conditions") {
          this._bParseError =
              false; // if conditions updated from outside parse error is
                     // obsolete. If updated from inside no parse error occurs
          ...
          for (i = 0; i < this._aAsyncChanges.length; i++) {
            ...
            if (oChange.waitForUpdate &&
                deepEqual(oChange.result, oChanges.current)) {
          ...
          // in display mode rerender if changed from or to empty (show or hide
          // empty-indicator)
          if ((oChanges.current.length === 0 || oChanges.old.length === 0) &&
              this.getShowEmptyIndicator() &&
              this.getEditMode() === EditMode.Display && !this.getContent() &&
        ...
        if (oChanges.name === "delegate" && !this.bDelegateInitialized &&
            !this.bDelegateLoaded) {
      ...
      FieldBase.prototype.getIdForLabel = function() {
        ...
        if (aContent.length > 0) {
          ...
          sId = _getIdForInternalControl.call(
              this); // if not rendered use ID for later created inner control
        }
       ...
       *
       * In the case that number and unit are shown in different controls, this
       * is the unit control, not the number control.
       *
      ...
      /**
       * In the case that number and unit are shown in different controls, only
       * one unit is supported. So the value help needs to be in single
       * selection mode.
       *
       ...
       */
      FieldBase.prototype.enhanceAccessibilityState = function(oElement,
                                                               mAriaProps) {
        var oParent = this.getParent();

        if (oParent && oParent.enhanceAccessibilityState) {
          // use Field as control, but aria properties of rendered inner
          // control.
      ...
      function _setAriaAttributes(bOpen, sItemId) {
        ...
        if (oFieldHelp) {
          var sRoleDescription =
              oFieldHelp.getRoleDescription(this.getMaxConditionsForHelp());
      ...
      /**
       * Assigns a <code>Label</code> control to the <code>Field</code> or
       * </code>FilterField</code> controls.
       *
       * The text of the label is taken from the <code>Field</code> or
       * </code>FilterField</code> controls. The <code>labelFor</code>
       * association is set to the <code>Field</code> or
       * </code>FilterField</code> control.
       *
       * @param {sap.ui.core.Label} oLabel Label control
       * @returns {sap.ui.mdc.field.FieldBase} Reference to <code>this</code> to
       ...
       * @since 1.62.0 Disclaimer: this function is in a beta state -
       * incompatible API changes may be done before its official public
       * release. Use at your own discretion.
       * @ui5-metamodel This method also will be described in the UI5 (legacy)
      ...
      /*
       * If the inner control changes or the inner control is created after the
       * Label is rendered the Label needs to be re-rendered. The DOM-node of
       * the "for" attribute needs to be updated.
       */
      ...
      function _contentChanged(oContent, sMutation, sName) {
        ...
        if (sMutation === "remove") {
          ...
          // as for edit and display different Types are possible switch them
          // with edit mode
          if (!this._oContentConditionTypes) {
          ...
          for (sProperty in oContent.getMetadata().getAllProperties()) {
            if (oContent.getBindingPath(sProperty) === "/conditions") {
              ...
              if (oBindingInfo && oBindingInfo.type &&
                  oBindingInfo.type instanceof ConditionsType) {
                this._oContentConditionTypes[sName].oConditionsType =
                    oBindingInfo.type;
              }
              this._sBoundProperty = sProperty;
            }
            if (sProperty === "editable" &&
                !oContent.getBindingPath(sProperty) &&
                oContent.isPropertyInitial(sProperty)) {
              oContent.bindProperty(
                  sProperty,
                  {path : "$field>/editMode", formatter : _getEditable});
            }
            if (sProperty === "enabled" &&
                !oContent.getBindingPath(sProperty) &&
                oContent.isPropertyInitial(sProperty)) {
              oContent.bindProperty(
                  sProperty,
                  {path : "$field>/editMode", formatter : _getEnabled});
            }
            if (sProperty === "displayOnly" &&
                !oContent.getBindingPath(sProperty) &&
                oContent.isPropertyInitial(sProperty)) {
              oContent.bindProperty(
                  sProperty,
                  {path : "$field>/editMode", formatter : _getDisplayOnly});
            }
            ...
            if (sProperty === "textAlign" &&
                !oContent.getBindingPath(sProperty) &&
                oContent.isPropertyInitial(sProperty)) {
              oContent.bindProperty(sProperty, {path : "$field>/textAlign"});
            }
            if (sProperty === "textDirection" &&
                !oContent.getBindingPath(sProperty) &&
                oContent.isPropertyInitial(sProperty)) {
              oContent.bindProperty(sProperty,
                                    {path : "$field>/textDirection"});
            }
            if (sProperty === "valueState" &&
                !oContent.getBindingPath(sProperty) &&
                oContent.isPropertyInitial(sProperty)) {
              oContent.bindProperty(sProperty, {path : "$field>/valueState"});
            }
            if (sProperty === "valueStateText" &&
                !oContent.getBindingPath(sProperty) &&
                oContent.isPropertyInitial(sProperty)) {
              oContent.bindProperty(sProperty,
                                    {path : "$field>/valueStateText"});
            }
            if (sProperty === "placeholder" &&
                !oContent.getBindingPath(sProperty) &&
                oContent.isPropertyInitial(sProperty)) {
          ...
          for (var sAggregation in
               oContent.getMetadata().getAllAggregations()) {
            if (oContent.getBindingPath(sAggregation) === "/conditions") {
              ...
              if (oBindingInfo && oBindingInfo.template) {
                for (sProperty in
                     oBindingInfo.template.getMetadata().getAllProperties()) {
                  var oTemplateBindingInfo =
                      oBindingInfo.template.getBindingInfo(sProperty);
                  if (oTemplateBindingInfo && oTemplateBindingInfo.type &&
                      oTemplateBindingInfo.type instanceof ConditionType) {
                    this._oContentConditionTypes[sName].oConditionType =
                        oTemplateBindingInfo.type;
                    break;
                  }
                }
              }
            }
            if (sAggregation === "tooltip" &&
                !oContent.getBindingPath(sAggregation) &&
                !oContent.getAggregation(sAggregation)) {
      ...
      function _setUsedConditionType() {
        ...
        if (this.getContent()) {
          if (this._oContentConditionTypes.content) {
            oConditionType =
                this._oContentConditionTypes.content.oConditionType;
            oConditionsType =
                this._oContentConditionTypes.content.oConditionsType;
          }
        } else if (sEditMode === EditMode.Display && this.getContentDisplay()) {
          if (this._oContentConditionTypes.contentDisplay) {
            oConditionType =
                this._oContentConditionTypes.contentDisplay.oConditionType;
            oConditionsType =
                this._oContentConditionTypes.contentDisplay.oConditionsType;
          }
        } else if (sEditMode !== EditMode.Display && this.getContentEdit()) {
          if (this._oContentConditionTypes.contentEdit) {
            oConditionType =
                this._oContentConditionTypes.contentEdit.oConditionType;
            oConditionsType =
                this._oContentConditionTypes.contentEdit.oConditionsType;
          }
        }
      ...
      function _createInternalContent() {
        ...
        _setUsedConditionType.call(
            this); // if external content use it's conditionType
        _checkFieldHelpExist.call(
            this, this.getFieldHelp()); // as FieldHelp might be greated after
                                        // ID is assigned to Field
        ...
        if (this.getContent() || this._bIsBeingDestroyed ||
          ...
          if (aContent.length === 1) {
            _setModelOnContent.call(this,
                                    aContent[0]); // bind to ManagedObjectModel
          }
          return;
        }
        ...
        var sBaseType = this.getTypeUtil().getBaseType(
            sDataType, oDataTypeFormatOptions, oDataTypeConstraints);
        ...
        if (aContentOld.length > 0) {
          ...
          sControlNameOld =
              oContentOld.getMetadata().getName().replace(/\./g, "/");
        }
        ...
        if (!oControlType) {
          ...
          if (this.getFieldInfo() && this._bTriggerable) {
            ...
            if (regexp.test(this.getFieldPath()) &&
                this.getMaxConditions() === 1) {
        ...
        } else if (aOperators.length === 1 && oControlType.editOperator &&
                   oControlType.editOperator[aOperators[0]]) {
        ...
        if (!sControlName) {
          throw new Error("No control defined for type " + sDataType + " in " +
                          this);
        }
        ...
        if (sControlName !== sControlNameOld) {
          this._bHideOperator = _isOnlyOneSingleValue.call(
              this, aOperators); // in single value eq Field hide operator
          ...
          if (!MyControl) {
            if (mControls[sControlName].promise) {
              mControls[sControlName].promise.then(
                  _createInternalContent.bind(this));
              return;
            } else {
              mControls[sControlName].promise =
                  new Promise(function(fResolve) {
                    ...
                    sap.ui.require(aControlNames, _controlLoaded.bind(this));
                      ...
                      .then(_createInternalContent.bind(this));
              return;
            }
          }

          if (_useDefaultFieldHelp.call(this, oControlType, aOperators,
                                        sEditMode, iMaxConditions)) {
            // use default field help
            _createDefaultFieldHelp.call(this,
                                         oControlType.useDefaultFieldHelp.name);
          } else if (this._sDefaultFieldHelp) {
            delete this._sDefaultFieldHelp; // do not destroy as might used on
                                            // other Fields too
          }
          ...
          for (i = 0; i < aControls.length; i++) {
            ...
            oControl.attachEvent("validationError", _handleValidationError,
                                 this);
            _modifyKeyboardHandler.call(this, oControl,
                                        oControlType.defaultEnterHandler);
            _setModelOnContent.call(this, oControl);
            if (this._bConnected && ((i === 0 && !this._bIsMeasure) ||
                                     (i === 1 && this._bIsMeasure))) {
      ...
      function _getIdForInternalControl() { return this.getId() + "-inner"; }
      ...
      function _destroyInternalContent() {
        ...
        // if the internalContent must be new created the data type must be
        // switched back to original one so new creation of control is using
        // original data
        this.destroyAggregation("_content");
      ...
      function _createSearchField(SearchField, sId) {
        ...
        var oControl = new SearchField(sId, {
          ...
          }, // oneWay as SearchField updates "value" while typing
          placeholder : "{$field>/placeholder}",
          width : "100%",
          tooltip : "{$field>/tooltip}",
          search : _handleEnter.bind(
              this), // submit event should be fired on Enter and Search-button
          change : _handleContentChange.bind(this),
          liveChange : _handleContentLiveChange.bind(this)
        });
      ...
      function _createMultiInputControl(MultiInput, sId) {
        ...
        var oToken = new Token(
            sId + "-token", {text : {path : '$field>', type : oConditionType}});
      ...
      function _createUnitInputControls(Input, sId) {
        ...
        var oInput1 = new Input(sId, {
          ...
          tooltip : "{$field>/tooltip}",
          fieldGroupIds :
              [ this.getId() ], // use FieldGroup to fire change only if focus
                                // leaved complete Field
          change : _handleContentChange.bind(this),
          liveChange : _handleContentLiveChange.bind(this)
        });
      ...
      function _addUnitControl(aControls, sId, Input) {
        ...
        if (this.getEditMode() === EditMode.EditableDisplay) {
          aControls[0].bindProperty(
              "description",
              {path : "$field>/conditions", type : oUnitConditionsType});
          ...
          var oInput = new Input(sId + "-unit", {
            ...
            required : "{$field>/required}",
            editable :
                {path : "$field>/editMode", formatter : _getEditableUnit},
            enabled : {path : "$field>/editMode", formatter : _getEnabled},
            valueState : "{$field>/valueState}",
            valueHelpIconSrc : _getFieldHelpIcon.call(this),
            valueStateText : "{$field>/valueStateText}",
      ...
      function _handleKeybordEvent(oEvent) {
        ...
        if (!oFieldHelp) {
          ...
          // FieldHelp closed, prevent only arrow up and down as used to
          // navigate
          switch (oEvent.type) {
          case "sapprevious":
          case "sapup":
      ...
      function _createDefaultFieldHelp(sType) {
        ...
        if (!oFieldHelp) {
          if (mDefaultHelps[sType].promise) {
            mDefaultHelps[sType].promise.then(
                _defaultFieldHelpUpdate.bind(this));
          }
          var FieldHelp = sap.ui.require(mDefaultHelps[sType].name);
          if (!FieldHelp && !mDefaultHelps[sType].promise) {
            mDefaultHelps[sType].promise =
                new Promise(function(fResolve) {
                  mDefaultHelps[sType].resolve = fResolve;
                  sap.ui.require([ mDefaultHelps[sType].name ],
                                 function(fnControl) {
                                   _createDefaultFieldHelp.call(this, sType);
                                 }.bind(this));
                }.bind(this))
                    .then(_defaultFieldHelpUpdate.bind(this));
          }
          if (FieldHelp) {
            var oDelegate =
                this.bDelegateInitialized &&
                this.getControlDelegate()[mDefaultHelps[sType].getDelegate]();
            var oProperties =
                merge({delegate : oDelegate}, mDefaultHelps[sType].properties);
      ...
      function _useDefaultFieldHelp(oControlType, aOperators, sEditMode,
                                    iMaxConditions) {

        if (oControlType.useDefaultFieldHelp && !this.getFieldHelp() &&
            sEditMode !== EditMode.Display) {
          if (aOperators.length === 1) {
            var bIsSingleValue = _isOnlyOneSingleValue.call(
                this, aOperators); // if operator not exists unse no field help
            // not if operator is handled by special control (like DatePicker)
            if (iMaxConditions === 1) {
              if (!(oControlType.editOperator &&
                    oControlType.editOperator[aOperators[0]]) &&
                  (oControlType.useDefaultFieldHelp.oneOperatorSingle ||
                   !bIsSingleValue)) {
                // "bool" case (always default field help) or operator needs
                // more than one value (e.g. between)
                return true;
              }
            } else if (oControlType.useDefaultFieldHelp.oneOperatorMulti ||
                       !bIsSingleValue) {
              // DatePicker case - in multi-value use default help to get
              // DatePicker controls
              return true;
            }
          } else {
      ...
      function _handleParseError(oEvent) {
        ...
        // as change event if inner control is fired even Input is wrong, check
        // parse exception from binding
      ...
      function _handleValidationError(oEvent) {
        ...
        // as change event if inner control is fired even Input is wrong, check
        // validation exception from binding
        this._bParseError = true;
          ...
          if (oChange.waitForUpdate && Array.isArray(oChange.result)) {
            if (oChange.result.length === 0 && vValue === "") {
              ...
              for (var j = 0; j < oChange.result.length; j++) {
                ...
                if (deepEqual(oCondition.values[0], vValue) ||
                    (oCondition.operator === "BT" &&
                     deepEqual(oCondition.values[1], vValue))) {
                  oChange.reject(oEvent.getParameter("exception"));
                  bFound = true;
                  break;
                }
      ...
      function _handleContentChange(oEvent) {
        ...
        var oChangeEvent = {
          parameters : merge({}, oEvent.getParameters()),
          source : oEvent.getSource()
        };
        var iLength = this._aAsyncChanges.length;

        if (iLength > 0 && !this._aAsyncChanges[iLength - 1].changeFired) {
          // as change event in Input is directly fired after setValue this must
          // be the change event corresponding to the last async change. as
          // there might be a sync change after it, do not handle it twice.
          this._aAsyncChanges[iLength - 1].changeFired = true;
          this._aAsyncChanges[iLength - 1].changeEvent = oChangeEvent;
          _triggerChange.call(this, undefined, undefined, undefined,
                              this._aAsyncChanges[iLength - 1].promise);
          return;
        }
      ...
      function _performContentChange(oChange) {
        ...
        var bAsync = false;
        var bChanged = true; // normally only called on real change. But in
                             // SearchField called on every ENTER
        var bChangeIfNotChanged =
            false; // in SearchField case fire change even if value not changed.
                   // TODO: other event for this

        if (oChange.changeEvent.parameters.hasOwnProperty("valid")) {
          bValid = oChange.changeEvent.parameters["valid"];
          if (!bValid &&
              oChange.changeEvent.parameters.hasOwnProperty("value")) {
        ...
        var oBinding =
            this._sBoundProperty && oSource.getBinding(this._sBoundProperty);
        if (oBinding && oBinding.getBindingMode() !== BindingMode.OneWay &&
            oBinding.getPath() === "/conditions" && bValid) {
              ...
              SyncPromise.resolve()
                  .then(function() {
                    ...
                    if (this._oNavigateCondition) {
                      // text entered via navigation -> use this data, no
                      // parsing is needed
                      bValid = true;
                      ...
                      if (iLength > 0 &&
                          !this._aAsyncChanges[iLength - 1].changeFired) {
                        oMyChange = this._aAsyncChanges[iLength - 1];
                        oMyChange.changeFired = true;
                        oMyChange.changeEvent = oChange.changeEvent;
                        _triggerChange.call(this, undefined, undefined,
                                            undefined, oMyChange.promise);
                      }
                      return vResult;
                    }
                  }.bind(this))
                  .then(function(oCondition) {
                    bChanged = _updateConditionsFromChange.call(
                        this, oCondition, aConditions, oConditionType, bValid,
                        vValue, oSource, oMyChange || oChange);
                    bChanged =
                        bChanged ||
                        bChangeIfNotChanged; // in SearchField fire change if
                                             // value not changed
                    return oCondition;
                  }.bind(this))
                  .catch(function(oException) {
                    if (oException && !(oException instanceof ParseException) &&
                        !(oException instanceof FormatException) &&
                        !(oException instanceof
                          ValidateException)) { // FormatException could also
                                                // occur
                    ...
                    if (oMyChange && oMyChange.reject) {
                      if (_removeAsyncChange.call(
                              this, oMyChange)) { // only if still valid (might
                                                  // be alredy rejected)
                        oMyChange.reject(oException);
                      }
                    } else if (bAsync) {
                      _triggerChange.call(this, aConditions, bValid,
                                          vWrongValue);
                    }
                  }.bind(this))
                  .unwrap();
        ...
        } else if (!oChange.changeEvent.parameters.hasOwnProperty("valid") &&
                   this._bParseError) {
        ...
        if (oFieldHelp && this._bConnected) {
          if (sap.ui.getCore().getCurrentFocusedControlId() ===
              oSource.getId()) {
            oFieldHelp.close(); // if focus is not in field, Field help closes
                                // automatically
          }
      ...
      function _updateConditionsFromChange(oCondition, aConditions,
                                           oConditionType, bValid, vValue,
                                           oSource, oChange) {
        ...
        if (oCondition === null && iMaxConditions !== 1) {
          ...
          // but fire change event as before a change event with invalid value
          // was fired
          return true;
        }
        ...
        if (bValid) {
          if (oCondition) {
            if (this._bIsMeasure && aConditions.length === 1 &&
                aConditions[0].values[0][0] === undefined) {
              // remove empty condition
              aConditions = [];
            }
            if (iMaxConditions !== 1 && FilterOperatorUtil.indexOfCondition(
                                            oCondition, aConditions) >= 0) {
              // condition already exist (only error if tokens, in SearchField
              // it is OK)
              throw new ParseException(this._oResourceBundle.getText(
                  "field.CONDITION_ALREADY_EXIST", [ vValue ]));
            } else {
          ...
          if (!deepEqual(aConditions, this.getConditions())) {
            this.setProperty("conditions", aConditions,
                             true); // do not invalidate whole field
            bChanged = true;
          }
      ...
      function _handleContentLiveChange(oEvent) {
        ...
        this._oNavigateCondition =
            undefined; // navigation item is not longer valid
        _updateConditionType.call(this);
        ...
        this._bParseError =
            false; // last parsing result is obsolete if user starts typing

        var oFieldHelp = _getFieldHelp.call(this);

        if (oFieldHelp && (!this._bIsMeasure || oSource.getShowValueHelp())) {
          if (bEscPressed) {
            // close FieldHelp if escape pressed and not repoen it for last
            // typed characters
            ...
            var aOperators =
                this._getOperators(); // show suggestion only if equal operators
                                      // are supported
            ...
            if (bUseFieldHelp) {
              this._bIgnoreInputValue =
                  false; // after typing the input value is the current one and
                         // should be used
              ...
              if (!this._fnLiveChangeTimer) {
                this._fnLiveChangeTimer = debounce(function() {
                  ...
                  if (this._vLiveChangeValue) {
                    ...
                    var aParts = oOperator.getValues(this._vLiveChangeValue,
                                                     sDisplay, true);
                    if (aParts[0]) {
                      vFilter = aParts[0];
                      if (aParts[1]) {
                  ...
                  if (this._bConnected && this._getContent()[0] &&
                      vOpenByTyping && !(vOpenByTyping instanceof Promise) &&
                      (sap.ui.getCore().getCurrentFocusedControlId() ===
                           this._getContent()[0].getId() ||
                       (this._getContent()[1] &&
                        sap.ui.getCore().getCurrentFocusedControlId() ===
                            this._getContent()[1]
                                .getId()))) { // only if still connected and
                                              // focussed
                    oFieldHelp.setFilterValue(vFilter);
                    if (this.getMaxConditionsForHelp() === 1 &&
                        oFieldHelp.getConditions().length > 0) {
                ...
                // on first call init FieldHelp (trigger loading metadata on
                // first typing)
                oFieldHelp.initBeforeOpen(true);
              }
              var vOpenByTyping =
                  oFieldHelp.openByTyping(); // trigger determination of search
                                             // functionality
              if (vOpenByTyping instanceof Promise) {
                vOpenByTyping.then(function() {
                  ...
                  var oFocusedElement = document.activeElement;
                  if (oFocusedElement &&
                      (containsOrEquals(this.getDomRef(), oFocusedElement)) &&
                      this._fnLiveChangeTimer) { // if destroyed
                                                 // this._fnLiveChangeTimer is
                                                 // removed
                    this._fnLiveChangeTimer();   // if resolved while initial
                                                 // debounce-time frame, it will
                                                 // not triggered twice
                  }
                }.bind(this));
              }
      ...
      function _handleTokenUpdate(oEvent) {
        ...
        if (oEvent.getParameter("type") === "removed") {
          ...
          if (this._bIsMeasure && sUnit && aConditions.length === 0) {
            ...
            aConditions = [ Condition.createItemCondition([ undefined, sUnit ],
                                                          undefined) ];
          }

          this.setProperty("conditions", aConditions,
                           true); // do not invalidate whole field
          _executeChange.call(this, aConditions,
                              true); // removing Token don't need to wait for
                                     // processing both fields in unit case
      ...
      function _fieldHelpChanged(sId, sMutation) {
        ...
        if (sMutation === "remove") {
          ...
          if (oFieldHelp) {
            ...
            oFieldHelp.detachEvent("afterClose", _handleFieldHelpAfterClose,
                                   this);
          }
        ...
        _handleConditionsChange.call(
            this, this.getConditions()); // to update descriptions
      }
        ...
        if (this._bIsMeasure) {
          ...
          for (var i = 0; i < aConditions.length; i++) {
            ...
            if (oCondition.values[0] && oCondition.values[0][1]) {
              var oHelpCondition = Condition.createItemCondition(
                  oCondition.values[0][1], undefined, oCondition.inParameters,
                  oCondition.outParameters);
      ...
      function _handleValueHelpRequest(oEvent) {
        ...
        if (oFieldHelp) {
          ...
          _setAriaAttributes.call(
              this, true); // if closed it will be set again on afterclose
          if (!oFieldHelp.isFocusInHelp()) {
            // need to reset bValueHelpRequested in Input, otherwise on focusout
            // no change event and navigation don't work
      ...
      function _handleFieldHelpSelect(oEvent) {
        ...
        if (this._bIsMeasure) {
          ...
          if (aConditions.length > 0) {
            ...
            oCondition =
                merge({}, aNewConditions[0]); // use selected condition to keep
                                              // in/out parameter
            oCondition.values[0] = [ undefined, oCondition.values[0] ];
            oCondition.values[1] = undefined;
            aConditions.push(oCondition);
            // TODO: format once to update current value in type (as empty
            // condtions are not displayed as token)
          ...
          for (i = 0; i < aNewConditions.length; i++) {
            ...
            // take what ever comes from field help as valid - even if it is an
            // empty key
            var iIndex = bAdd ? -1
                              : FilterOperatorUtil.indexOfCondition(
                                    oCondition, aConditions);
            if (iIndex === -1) { // check if already exist
              aConditions.push(oCondition);
            } else if (oCondition.values[1] !== aConditions[iIndex].values[1] &&
                       aConditions[iIndex].values[1]) {
        ...
        if (oContent && oContent.setDOMValue) {
          if (this.getMaxConditionsForHelp() === 1 && aConditions.length > 0) {
            // the focus is still in the Field. The update of the inner control
            // is done via ManagedObjectModel binding. The inner Input is
            // configured to prefer user input in this case. so we need to set
            // the DOM value here. Otherwise it is not updated or, if empty,
            // selected.
            ...
            if (sDOMValue instanceof Promise) {
              ...
              sDOMValue.then(function(sText) {
                oContent.setDOMValue(
                    ""); // to overwrite it even if the text is the same ->
                         // otherwise cursor position could be wrong
            ...
            this._bIgnoreInputValue =
                true; // after something is selected, the value just stays for
                      // filtering -> don't use to create token
          }
        }
        ...
        if (!deepEqual(aConditions, aConditionsOld)) {
          ...
          if (!FilterOperatorUtil.compareConditionsArray(
                  aConditions, aConditionsOld)) { // update only if real change
      ...
      function _handleFieldHelpNavigate(oEvent) {
        ...
        if (oCondition) {
          ...
          this._oNavigateCondition =
              Condition.createItemCondition(vKey, sValue);
        }

        if (this._bIsMeasure) {
          var aConditions = this.getConditions();
          // use number of first condition. In Multicase all conditions must be
          // updated in change event
          if (aConditions.length > 0) {
            this._oNavigateCondition.operator = aConditions[0].operator;
            this._oNavigateCondition.values[0] = [
              aConditions[0].values[0][0], this._oNavigateCondition.values[0]
            ];
            if (aConditions[0].operator === "BT") {
              this._oNavigateCondition.values[1] = [
                aConditions[0].values[1][0],
                this._oNavigateCondition.values[0][1]
              ];
            } else {
            ...
            this._oNavigateCondition.values = [
              [ undefined, this._oNavigateCondition.values[0] ], undefined
            ];
          }
        }

        this._bPreventGetDescription =
            true; // if no description in navigated condition, no description
                  // exist. Don't try to read one
        _updateConditionType.call(this);
        ...
        if (oContent && oContent.setDOMValue) {
          if (!sDOMValue) {
            if (this._bIsMeasure && this._oUnitConditionsType &&
                this._oNavigateCondition) {
              sDOMValue = this._oUnitConditionsType.formatValue(
                  [ this._oNavigateCondition ]);
            } else if (this._oConditionType && this._oNavigateCondition) {
              sDOMValue =
                  this._oConditionType.formatValue(this._oNavigateCondition);
            } else if (this._oConditionsType && this._oNavigateCondition) {
              sDOMValue = this._oConditionsType.formatValue(
                  [ this._oNavigateCondition ]);
            } else {
      ...
      function _handleHelpDataUpdate(oEvent) {
        ...
        var isEditing = this.getEditMode() === EditMode.Editable &&
                        this._getContent().length > 0 &&
                        sap.ui.getCore().getCurrentFocusedControlId() ===
                            this._getContent()[0].getId();
        ...
        //this.getConditions());
        if (!isEditing && !this._bPendingConditionUpdate &&
            this.getConditions().length > 0 &&
            (this.getMaxConditions() !== 1 ||
             (this.getDisplay() !== FieldDisplay.Value &&
              !this._bParseError))) {
          // update tokens in MultiValue
          // update text/value only if no parse error, otherwise wrong value
          // would be removed don't update if contidions are outdated (updated
          // async in Field)
      ...
      function _connectFieldhelp() {
        ...
        if (oFieldHelp && !this._bConnected) {
          ...
          oFieldHelp.attachEvent("afterClose", _handleFieldHelpAfterClose,
                                 this);
          var aConditions = this.getConditions();
          _setConditionsOnFieldHelp.call(this, aConditions, oFieldHelp);
      ...
      function _setFocusHandlingForFieldHelp(oContent) {
        ...
        if (oContent && !oContent.orgOnsapfocusleave &&
            oContent.onsapfocusleave) {
          ...
          oContent.onsapfocusleave = function(oEvent) {
            ...
            if (oFieldHelp) {
              ...
              if (oFocusedControl) {
                if (containsOrEquals(oFieldHelp.getDomRef(),
                                     oFocusedControl.getFocusDomRef())) {
                  oEvent.stopPropagation();
                  return;
                } else {
      ...
      function _handleInfoDataUpdate() {
        ...
        oFieldInfo.isTriggerable().then(function(bTriggerable) {
          ...
          if (that.getAggregation("_content", []).length > 0 &&
              that.getEditMode() === EditMode.Display) {
            _createInternalContent.call(that);
            if (that._bTriggerable) {
              oFieldInfo.getDirectLinkHrefAndTarget().then(
                  _updateLink.bind(that));
            }
          }
        });
      }
      ...
      FieldBase.prototype._getFormatOptions = function() {
        if (!this._asyncParsingCall) {
          this._asyncParsingCall = _asyncParsingCall.bind(
              this); // as variable to have the same function after each update
                     // of formatOptions. Otherwise it would be a change on
                     // FormatOption in ValueHelpPanel every time
        }
        ...
        return {
          ...
          fieldHelpID : this._bIsMeasure
                            ? undefined
                            : this.getFieldHelp() || this._sDefaultFieldHelp,
          operators : this._getOperators(),
          hideOperator : this._bHideOperator,
          maxConditions : this.getMaxConditions(),
          bindingContext :
              this.getBindingContext(), // to dertmine text and key usding
                                        // in/out-parameter using correct
                                        // bindingContext (In Table FieldHelp
                                        // might be connected to other row)
      ...
      FieldBase.prototype._checkValueInitial = function(vValue) {
        ...
        if (vValue === "" ||
            (typeof (vValue) === "string" &&
             vValue.match(/^0+$/))) { // if String is dig-sequence, initial
                                      // value contains only "0"s
          var oType = _getDataType.call(this);
          ...
          if (this.getTypeUtil().getBaseType(sDataType) === BaseType.Unit &&
              Array.isArray(vValue) && vValue.length > 1 &&
              (vValue[0] === undefined || vValue[0] === null) &&
              !vValue[1]) { // as 0 is a valid number
      ...
      function _getUnitFormatOptions() {
        ...
        if (!this._asyncParsingCall) { // as variable to have the same function
                                       // after each update of formatOptions.
                                       // Otherwise it would be a change on
                                       // FormatOption in ValueHelpPanel every
                                       // time
        ...
        return {
          ...
          originalDateType :
              _getDataType.call(this), // use type of measure for currentValue
          ...
          preventGetDescription : this._bPreventGetDescription,
          isUnit : true,
          getConditions : this.getConditions.bind(
              this) // TODO: better solution to update unit in all conditions
        };
      }

      function _asyncParsingCall(oPromise) {

        // close FieldHelp to prevent action on it during parsing (only if still
        // focused, otherwise let autoclose do its work)
        var oFieldHelp = _getFieldHelp.call(this);
        ...
        // as async parsing can be called again while one is still running we
        // have to map the promises to resolve the right one.
        var oChange = {};
        var oMyPromise = new Promise(function(fResolve, fReject) {
          ...
          oPromise
              .then(function(vResult) { // vResult can be a condition or an
                                        // array of conditions
              ...
              .catch(function(oException) {
                if (oException && !(oException instanceof ParseException) &&
                    !(oException instanceof FormatException) &&
                    !(oException instanceof
                      ValidateException)) { // FormatException could also occur
                  // unknown error -> just raise it
                  throw oException;
                }
                this._bParseError = true;
      ...
      FieldBase.prototype._getOperators = function() {
        ...
        var sBaseType = this.getTypeUtil().getBaseType(
            sDataType, oFormatOptions,
            oConstraints); // TODO what if delegate not loaded

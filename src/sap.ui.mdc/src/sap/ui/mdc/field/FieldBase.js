    ...
    function(
      ...
      FieldBase.prototype.init = function() {
        ...
        this._oObserver = new ManagedObjectObserver(
            this._observeChanges.bind(this),
        );
      ...
      FieldBase.prototype.exit = function() {
        ...
        if (oFieldInfo) {
          ...
          oFieldInfo.detachEvent(
              "dataUpdate",
              _handleInfoDataUpdate,
              this,
          );
        }
      ...
      FieldBase.prototype.setProperty = function(
          sPropertyName,
          oValue,
          bSuppressInvalidate,
      ) {
      ...
      FieldBase.prototype.onfocusin = function(
          oEvent) { _connectFieldhelp.call(this); };

      FieldBase.prototype.onsapfocusleave = function(
          oEvent) { _clearLiveChangeTimer.call(this); };
      ...
      function _validateFieldGroup(oEvent) {
        ...
        if (aFieldGroup.indexOf(this.getId()) > -1) {
          // own FieldGroup left
        ...
        if (!oPromise) {
          ...
          if (bValid) {
            oPromise = Promise.resolve(
                this._getResultForPromise(aConditions),
            );
          } else {
      ...
      FieldBase.prototype._fireChange = function(
          aConditions,
          bValid,
          vWrongValue,
          oPromise,
      ...
      function _getDataTypeName() {
        if (this._oDataType && typeof this._oDataType === "object") {
          ...
          return this.getControlDelegate().getDataTypeClass(
              this.getPayload(),
              this.getDataType(),
          );
        } else {
      ...
      function _adjustDataTypeForDate() {
        ...
        if (!oFormatOptions || oFormatOptions.style ||
          ...
          this._oDataType = DateUtil.createInternalType(
              oType,
              this._sValueFormat,
          );
        ...
        if (oChanges.name === "dataType") {
          ...
          if (this._oDataType) {
            var fnCheck = function(sType) {
              var oTypeClass = this.getTypeUtil().getDataTypeClass(
                  oChanges.current,
              );
       ...
       */
      FieldBase.prototype.enhanceAccessibilityState = function(
          oElement,
          mAriaProps,
      ) {
        ...
        if (sMutation === "remove") {
          ...
          for (var sAggregation in
              ...
              if (oBindingInfo && oBindingInfo.template) {
                for (sProperty in
                  ...
                  var oTemplateBindingInfo =
                      oBindingInfo.template.getBindingInfo(
                          sProperty,
                      );
            ...
            if (sAggregation === "tooltip" &&
              ...
              oContent.bindProperty(sAggregation, {
                path : "$field>/tooltip",
              });
            }
          }
      ...
      function _attachContentHandlers(oContent) {
        ...
        if (oContent.getMetadata().getEvents().liveChange) {
          ...
          oContent.attachEvent(
              "liveChange",
              _handleContentLiveChange,
              this,
          );
        }
      ...
      function _createInternalContent() {
        ...
        if (!sControlName) {
          throw new Error(
              "No control defined for type " + sDataType + " in " + this,
          );
        }
        ...
        if (sControlName !== sControlNameOld) {
          this._bHideOperator = _isOnlyOneSingleValue.call(
              this,
              aOperators,
          ); // in single value eq Field hide operator
          ...
          for (i = 0; i < aControls.length; i++) {
            ...
            oControl.attachEvent(
                "validationError",
                _handleValidationError,
                this,
            );
            _modifyKeyboardHandler.call(
                this,
                oControl,
      ...
      function _createMultiInputControl(MultiInput, sId) {
        ...
        var oToken = new Token(sId + "-token", {
          text : {path : "$field>", type : oConditionType},
        });
      ...
      function _addUnitControl(aControls, sId, Input) {
        ...
        if (this.getEditMode() === EditMode.EditableDisplay) {
          aControls[0].bindProperty("description", {
            path : "$field>/conditions",
            type : oUnitConditionsType,
          });
      ...
      function _createDefaultFieldHelp(sType) {
        ...
        if (!oFieldHelp) {
          ...
          if (FieldHelp) {
            ...
            var oProperties = merge(
                {delegate : oDelegate},
                mDefaultHelps[sType].properties,
            );
            oFieldHelp = new FieldHelp(
                mDefaultHelps[sType].id,
                oProperties,
            );
        ...
        if (oControlType.useDefaultFieldHelp && !this.getFieldHelp() &&
          ...
          if (aOperators.length === 1) {
            var bIsSingleValue = _isOnlyOneSingleValue.call(
                this,
                aOperators,
            ); // if operator not exists unse no field help
      ...
      function _performContentChange(oChange) {
              ...
              SyncPromise.resolve()
                  ...
                  .then(
                      function(oCondition) {
                        ...
                        bChanged =
                            bChanged || bChangeIfNotChanged; // in SearchField
                        // fire change if
                        // value not changed
                        return oCondition;
                      }.bind(this),
                  ...
                  .catch(
                      function(oException) {
                        if (oException &&
                            !(oException instanceof ParseException) &&
                            !(oException instanceof FormatException) &&
                            !(oException instanceof ValidateException)) {
                          // FormatException could also
                          // occur
                        ...
                        if (oMyChange && oMyChange.reject) {
                          if (_removeAsyncChange.call(this, oMyChange)) {
                            // only if still valid (might
                            // be alredy rejected)
        ...
        if (oFieldHelp && this._bConnected) {
          ...
          if (!bAsync && bValid) {
            _setConditionsOnFieldHelp.call(
                this,
                aConditions,
                oFieldHelp,
            );
      ...
      function _updateConditionsFromChange(
          oCondition,
          aConditions,
          oConditionType,
          bValid,
          ...
          if (oCondition) {
            ...
            if (iMaxConditions !== 1 && FilterOperatorUtil.indexOfCondition(
              ...
              if (iMaxConditions > 0 && iMaxConditions <= aConditions.length) {
                ...
                aConditions.splice(
                    0,
                    aConditions.length - iMaxConditions + 1,
                );
              }
        ...
        if (oFieldHelp && (!this._bIsMeasure || oSource.getShowValueHelp())) {
          if (bEscPressed) {
            ...
            for (var i = 0; i < aOperators.length; i++) {
              var oOperator = FilterOperatorUtil.getOperator(
                  aOperators[i],
              );
                ...
                this._fnLiveChangeTimer = debounce(
                    function() {
                      ...
                      if (this._vLiveChangeValue) {
                        ...
                        var aParts = oOperator.getValues(
                            this._vLiveChangeValue,
                            sDisplay,
                            true,
                        );
                        if (aParts[0]) {
                      ...
                      if (this._bConnected && this._getContent()[0] &&
                          vOpenByTyping &&
                          !(vOpenByTyping instanceof Promise) &&
                          (sap.ui.getCore().getCurrentFocusedControlId() ===
                               this._getContent()[0].getId() ||
                           (this._getContent()[1] &&
                            sap.ui.getCore().getCurrentFocusedControlId() ===
                                this._getContent()[1].getId()))) {
                        // only if still connected and
                        // focussed
      ...
      function _handleContentPress(oEvent) {
        var oFieldInfo = this.getFieldInfo();
        if (oFieldInfo) {
          oFieldInfo.getTriggerHref().then(
              function(sHref) {
                if (!sHref) {
      ...
      function _handleTokenUpdate(oEvent) {
        if (oEvent.getParameter("type") === "removed") {
          ...
          for (i = 0; i < aRemovedTokens.length; i++) {
            ...
            var iIndex = parseInt(
                sPath.slice(sPath.lastIndexOf("/") + 1),
            );
          ...
          for (var i = 0; i < aConditions.length; i++) {
            ...
            if (oCondition.values[0] && oCondition.values[0][1]) {
              var oHelpCondition = Condition.createItemCondition(
                  oCondition.values[0][1],
                  undefined,
                  oCondition.inParameters,
        ...
        if (oContent && oContent.setDOMValue) {
          if (this.getMaxConditionsForHelp() === 1 && aConditions.length > 0) {
            ...
            if (this._bIsMeasure && this._oUnitConditionsType) {
              ...
              sDOMValue = this._oConditionType.formatValue(
                  aConditions[0],
              );
            } else if (this._oConditionsType) {
              sDOMValue = this._oConditionsType.formatValue(aConditions);
      ...
      function _handleFieldHelpNavigate(oEvent) {
        ...
        if (oCondition) {
          ...
          this._oNavigateCondition = Condition.createItemCondition(
              vKey,
              sValue,
          );
        }
        ...
        if (this._bIsMeasure) {
          ...
          if (aConditions.length > 0) {
            ...
            this._oNavigateCondition.values = [
              [ undefined, this._oNavigateCondition.values[0] ],
              undefined,
            ];
          }
        }
       ...
       */
      FieldBase.prototype._updateConditionType =
          function() { _updateConditionType.call(this); };
      ...
      FieldBase.prototype._checkValueInitial = function(vValue) {
        ...
        if (vValue === "" ||
            (typeof vValue === "string" && vValue.match(/^0+$/))) {
          // if String is dig-sequence, initial
          ...
          if (this.getTypeUtil().getBaseType(sDataType) === BaseType.Unit &&
              ...
              (vValue[0] === undefined || vValue[0] === null) && !vValue[1]) {
            // as 0 is a valid number
      ...
      function _getUnitFormatOptions() {
        if (!this._asyncParsingCall) {
          // as variable to have the same function
        ...
        var oMyPromise = new Promise(
            function(fResolve, fReject) {
              ...
              oPromise
                  .then(
                      function(vResult) {
                        // vResult can be a condition or an
                        // array of conditions
                  ...
                  .catch(
                      function(oException) {
                        if (oException &&
                            ...
                            !(oException instanceof FormatException) &&
                            !(oException instanceof ValidateException)) {
                          // FormatException could also occur
                          // unknown error -> just raise it
                          throw oException;
                        }
                        this._bParseError = true;
      ...
      FieldBase.prototype._getOperators = function() {
        ...
        var sBaseType = this.getTypeUtil().getBaseType(
            ...
            oFormatOptions,
            oConstraints,
        ); // TODO what if delegate not loaded

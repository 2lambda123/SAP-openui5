...
sap.ui.define(
    ...
    function (
        ...
        QUnit.test(
            ...
            function (assert) {
                sap.ui
                    .getCore()
                    .getMessageManager()
                    .registerObject(oField3, true); // to activate message manager
                var fnDone = assert.async();
        ...
        QUnit.test("update while user input pending", function (assert) {
            ...
            oField.placeAt("content");
            sap.ui.getCore().applyChanges();
            oField.setValue([undefined, undefined, oCurrencyCodeList]); // after rendering to create internal data type (as we don't use
            // binding here)
            ...
            setTimeout(function () {
                ...
                setTimeout(function () {
                    ...
                    setTimeout(function () {
                        // model update
                        assert.equal(
                            oField.setProperty.withArgs("value").getCalls()
                                .length,
                            0,
                            "value not updated",
                        );
